...
function aParte(r: ParteRow): Parte {
  return {
    ...
    cuentaCci: r.cuentaCci,
    cuentaTitular: r.cuentaTitular,
    whatsapp: r.whatsapp,
...
export const ForestDirectorioDB = {
  ...
  async guardarParte(
    ...
    const campos = {
      ...
      banco: vacioANull(input.banco),
      cuentaNumero: vacioANull(input.cuentaNumero),
      cuentaCci: vacioANull(input.cuentaCci),
      cuentaTitular: vacioANull(input.cuentaTitular),
