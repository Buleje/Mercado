          ...
          <table style="width:100%;border-collapse:collapse;font-size:13px;">
            <thead>
              <tr style="background:#f0fdf4;">
                <th style="text-align:left;padding:6px 8px;color:#00A0A0;">Producto</th>
                <th style="text-align:right;padding:6px 8px;color:#00A0A0;">Subtotal</th>
              </tr>
            </thead>
            ...
            <tfoot>
              <tr style="background:#f0fdf4;">
                ...
                <td style="padding:8px;text-align:right;font-weight:bold;color:#00A0A0;font-size:16px;">S/${order.total.toFixed(2)}</td>
              </tr>
            </tfoot>
          </table>
        </div>
        ...
        <div style="padding:16px 24px;">
          <table style="width:100%;border-collapse:collapse;font-size:14px;">
            ...
            <tr style="border-bottom:2px solid #cbd5e1;background:#f1f5f9;">
              ...
              <td style="padding:10px 4px;text-align:right;font-weight:700;color:#00A0A0;">${fmt(summary.expectedAmount)}</td>
            </tr>
            <tr style="border-bottom:1px solid #e2e8f0;">
