...
export const CATALOG_CATEGORIES: CatalogCategoryMeta[] = [
  { id: "abarrotes",       label: "Abarrotes",         emoji: "🏪", color: "#00A0A0" },
  ...
  { id: "frutas-verduras", label: "Frutas y Verduras", emoji: "🥬", color: "#22c55e" },
  { id: "panaderia",       label: "Panaderia",         emoji: "🍞", color: "#d97706" },
  { id: "licores",         label: "Licores",           emoji: "🍺", color: "#7c3aed" },
  { id: "congelados",      label: "Congelados",        emoji: "🧊", color: "#0ea5e9" },
];
