...
export const TRANSLATIONS: Record<string, TranslationEntry> = {
  ...
  "plans.tagline.pro": {
    es: "Para negocios que ya venden y quieren escalar",
    en: "For businesses already selling that want to scale",
    shi: "Negociopaq",
  },
  "plans.tagline.enterprise": {
    es: "Cadenas y operaciones de varias sucursales",
    en: "Chains and multi-branch operations",
    shi: "Achka qhatu",
  },
  "plans.tagline.max": {
    es: "Todo desbloqueado · sin límites · soporte 24/7",
    en: "Everything unlocked · no limits · 24/7 support",
    shi: "Tukuy · mana límite · 24/7",
  },
  "plans.afterMonthly": {
