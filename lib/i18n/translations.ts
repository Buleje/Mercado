...
export const TRANSLATIONS: Record<string, TranslationEntry> = {
  ...
  "landing.how.step1.title": { es: "Activa tu negocio", en: "Activate your business", shi: "Negocioyki kichay" },
  ...
  "landing.how.step2.title": { es: "Atraes clientes", en: "Attract customers", shi: "Rantiqkuna" },
  "landing.how.step2.desc": { es: "Apareces en buscadores, mapa y app sin pagar publicidad.", en: "You show up in searches, map and app — no paid ads.", shi: "Buscadores." },
  "landing.how.step2.tag": { es: "Crecimiento", en: "Growth", shi: "Wiñay" },
  "landing.how.step3.title": { es: "Cobras al instante", en: "Get paid instantly", shi: "Pagay utqay" },
  ...
  "landing.how.step4.title": { es: "Entregas sin estrés", en: "Deliver stress-free", shi: "Apachiy" },
  ...
  "about.value1.desc": {
    es: "Vendes directo, sin intermediarios. Nosotros ponemos la tecnología; tú decides precios, promociones y delivery.",
    en: "Sell direct, no middlemen. We provide the tech; you decide prices, promos and delivery.",
    shi: "Mana intermediario.",
  },
  "about.value2.title": { es: "Llegas a más vecinos", en: "Reach more neighbors", shi: "Astawan vecinokuna" },
  "about.value2.desc": {
  ...
  "about.value3.title": { es: "Conoces a quien te compra", en: "Know who buys from you", shi: "Riqsiy rantiqkunata" },
  "about.value3.desc": {
    es: "Historial, reseñas y notas por cliente. Recuerdas cumpleaños, productos favoritos y los recompensas.",
