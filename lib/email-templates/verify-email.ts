      ...
      <div style="font-family:'Segoe UI',Arial,sans-serif;max-width:560px;margin:0 auto;background:#fff;border:1px solid #e0e0e0;border-radius:12px;overflow:hidden;">
        ...
        <div style="padding:32px 24px;">
          ...
          <div style="text-align:center;margin:0 0 32px;">
            <a
              href="${verifyUrl}"
              style="background:#00B4A6;color:#fff;padding:14px 40px;border-radius:8px;text-decoration:none;font-weight:700;font-size:16px;display:inline-block;letter-spacing:0.3px;"
            >
              Verificar mi email
            </a>
          </div>
