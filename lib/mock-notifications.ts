...
export const MOCK_NOTIFICATIONS: Notification[] = [
  ...
  },
  {
    ...
    body: "Tu cuenta está lista. Completa tu perfil para recibir mejores recomendaciones.",
  ...
  },
  {
    ...
    body: "Usa el código LIMPIO10 en tu próximo pedido de productos de limpieza. Vence en 3 días.",
    timestamp: now - 2 * day,
    read: true,
  ...
  },
  {
    ...
    body: "Cada compra acumula el doble de puntos hasta el domingo. Aprovecha para canjear premios.",
    timestamp: now - 8 * day,
    read: true,
    actionUrl: "/mi-puntos",
  ...
  },
  {
    ...
    body: "Revisa los cambios en nuestra política de privacidad antes del 30 de abril.",
