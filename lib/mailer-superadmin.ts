...
export async function sendSuperAdminAlert(alert: SuperAdminAlert): Promise<void> {
  ...
  const actionHtml = alert.actionUrl
    ? `<div style="text-align:center;margin:24px 0 8px;">
         <a href="${alert.actionUrl}" style="background:#2d6a4f;color:#fff;padding:10px 28px;border-radius:8px;text-decoration:none;font-weight:600;font-size:14px;display:inline-block;">
