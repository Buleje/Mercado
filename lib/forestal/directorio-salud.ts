 ...
 */
export function pendientesDeFicha(f: FichaParaSalud): Pendiente[] {
...
export function completitud(f: FichaParaSalud): number {
  const faltan = pendientesDeFicha(f);
