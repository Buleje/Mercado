...
<svg width="400" height="400" viewBox="0 0 400 400" xmlns="http://www.w3.org/2000/svg">
  ...
  <g transform="translate(150, 150)">
    <path d="M20 14L10 24v40c0 4 2 6 6 6h68c4 0 6-2 6-6V24l-10-10H20z" 
          stroke="#6366f1" stroke-width="3" fill="#e9ecef" opacity="0.5"/>
    <path d="M10 24h80" stroke="#6366f1" stroke-width="3"/>
...
export function generateGradientPlaceholder(
  colorStart: string = "#6366f1",
  colorEnd: string = "#818cf8",
  width: number = 400,
  height: number = 400
): string {
  const svg = `
...
export const PLACEHOLDERS = {
  ...
  gradientPrimary: generateGradientPlaceholder("#6366f1", "#818cf8"),
