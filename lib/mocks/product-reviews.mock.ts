...
export const MOCK_REVIEWS_LIBRARY: Omit<MockReview, "productId">[] = [
  {
    ...
    body: "La señora Elena atiende bien. Pide por la tarde y para la cena ya estaba en la casa. El producto está tal como sale en la foto, nada de sorpresas feas. Lo recomiendo a las vecinas de Yarinacocha.",
    photos: [],
  ...
  },
  {
    ...
    body: "Comparé con la bodega de la esquina y aquí sale más conveniente. El único pero es que el empaque vino medio aplastado pero el contenido está bien. Volvería a comprar.",
    photos: [],
    verifiedPurchase: true,
    helpfulCount: 8,
    createdAt: iso(7),
  },
  {
    ...
    body: "Mi mamá siempre compraba aquí cuando yo era chibola. Ahora que pido por delivery siento el mismo cuidado. Gracias por mantener la tradición en Pucallpa.",
    photos: [],
    verifiedPurchase: true,
    helpfulCount: 22,
    createdAt: iso(12),
