...
const outDir = process.argv[2] ?? "reports/visual-verify/abrir-tienda";
...
async function capture(theme) {
  ...
  await page.goto(`${BASE}/abrir-tienda`, { waitUntil: "networkidle", timeout: 60000 });
  await page.waitForTimeout(3000);
  const out = `${outDir}/abrir-tienda-${theme}.png`;
