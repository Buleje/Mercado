...
const RULES: Rule[] = [
  ...
  // ── Neutral surfaces (ADR-074) ─────────────────────────────────────────────
  // Admin/superadmin usaban bg-white/bg-gray-* hardcoded. Se migran a tokens
  // semanticos surface/text/rule. Patrones compuestos (light + dark) primero.
  {
    id: "bg-white-dark-gray-950",
    pattern: /bg-white\s+dark:bg-gray-950/g,
    replacement: "bg-[var(--surface-canvas)]",
  },
  {
    id: "bg-white-dark-gray-900",
    pattern: /bg-white\s+dark:bg-gray-900/g,
    replacement: "bg-[var(--surface-raised)]",
  },
  {
    id: "bg-white-dark-gray-800",
    pattern: /bg-white\s+dark:bg-gray-800/g,
    replacement: "bg-[var(--surface-raised)]",
  },
  {
    id: "bg-gray-50-dark-gray-900",
    pattern: /bg-gray-50\s+dark:bg-gray-900/g,
    replacement: "bg-[var(--surface-canvas)]",
  },
  {
    id: "bg-gray-50-dark-gray-950",
    pattern: /bg-gray-50\s+dark:bg-gray-950/g,
    replacement: "bg-[var(--surface-canvas)]",
  },
  {
    id: "bg-gray-50-dark-gray-800",
    pattern: /bg-gray-50\s+dark:bg-gray-800/g,
    replacement: "bg-[var(--surface-sunken)]",
  },
  {
    id: "bg-gray-100-dark-gray-800",
    pattern: /bg-gray-100\s+dark:bg-gray-800/g,
    replacement: "bg-[var(--surface-sunken)]",
  },
  {
    id: "bg-gray-100-dark-gray-900",
    pattern: /bg-gray-100\s+dark:bg-gray-900/g,
    replacement: "bg-[var(--surface-sunken)]",
  },
  {
    id: "bg-gray-100-dark-gray-700",
    pattern: /bg-gray-100\s+dark:bg-gray-700/g,
    replacement: "bg-[var(--surface-sunken)]",
  },
  // Borders gray neutrales (pares light/dark primero)
  {
    id: "border-gray-100-dark-gray-800",
    pattern: /border-gray-100\s+dark:border-gray-800/g,
    replacement: "border-[var(--rule-soft)]",
  },
  {
    id: "border-gray-200-dark-gray-800",
    pattern: /border-gray-200\s+dark:border-gray-800/g,
    replacement: "border-[var(--rule-base)]",
  },
  {
    id: "border-gray-200-dark-gray-700",
    pattern: /border-gray-200\s+dark:border-gray-700/g,
    replacement: "border-[var(--rule-base)]",
  },
  {
    id: "border-gray-300-dark-gray-700",
    pattern: /border-gray-300\s+dark:border-gray-700/g,
    replacement: "border-[var(--rule-base)]",
  },
  // Text grises neutrales (pares light/dark primero)
  {
    id: "text-gray-900-dark-white",
    pattern: /text-gray-900\s+dark:text-white/g,
    replacement: "text-[var(--text-primary)]",
  },
  {
    id: "text-gray-900-dark-gray-100",
    pattern: /text-gray-900\s+dark:text-gray-100/g,
    replacement: "text-[var(--text-primary)]",
  },
  {
    id: "text-gray-800-dark-white",
    pattern: /text-gray-800\s+dark:text-white/g,
    replacement: "text-[var(--text-primary)]",
  },
  {
    id: "text-gray-700-dark-gray-300",
    pattern: /text-gray-700\s+dark:text-gray-300/g,
    replacement: "text-[var(--text-secondary)]",
  },
  {
    id: "text-gray-700-dark-gray-400",
    pattern: /text-gray-700\s+dark:text-gray-400/g,
    replacement: "text-[var(--text-secondary)]",
  },
  {
    id: "text-gray-800-dark-gray-200",
    pattern: /text-gray-800\s+dark:text-gray-200/g,
    replacement: "text-[var(--text-primary)]",
  },
  {
    id: "text-gray-800-dark-gray-100",
    pattern: /text-gray-800\s+dark:text-gray-100/g,
    replacement: "text-[var(--text-primary)]",
  },
  {
    id: "text-gray-700-dark-gray-200",
    pattern: /text-gray-700\s+dark:text-gray-200/g,
    replacement: "text-[var(--text-secondary)]",
  },
  {
    id: "text-gray-600-dark-gray-400",
    pattern: /text-gray-600\s+dark:text-gray-400/g,
    replacement: "text-[var(--text-secondary)]",
  },
  {
    id: "text-gray-600-dark-gray-300",
    pattern: /text-gray-600\s+dark:text-gray-300/g,
    replacement: "text-[var(--text-secondary)]",
  },
  {
    id: "text-gray-500-dark-gray-400",
    pattern: /text-gray-500\s+dark:text-gray-400/g,
    replacement: "text-[var(--text-tertiary)]",
  },
  {
    id: "text-gray-500-dark-gray-500",
    pattern: /text-gray-500\s+dark:text-gray-500/g,
    replacement: "text-[var(--text-tertiary)]",
  },
  {
    id: "text-gray-400-dark-gray-500",
    pattern: /text-gray-400\s+dark:text-gray-500/g,
    replacement: "text-[var(--text-tertiary)]",
  },
  // Hover surfaces gray
  {
    id: "hover-bg-gray-100-dark-gray-800",
    pattern: /hover:bg-gray-100\s+dark:hover:bg-gray-800/g,
    replacement: "hover:bg-[var(--surface-sunken)]",
  },
  {
    id: "hover-bg-gray-50-dark-gray-800",
    pattern: /hover:bg-gray-50\s+dark:hover:bg-gray-800/g,
    replacement: "hover:bg-[var(--surface-sunken)]",
  },
  {
    id: "hover-bg-gray-50-dark-gray-900",
    pattern: /hover:bg-gray-50\s+dark:hover:bg-gray-900/g,
    replacement: "hover:bg-[var(--surface-sunken)]",
  },
  // Teal = accent (brand primary). Admin/superadmin usaban teal-600 como brand.
  {
    id: "bg-teal-600-dark-teal-400",
    pattern: /bg-teal-600\s+dark:bg-teal-400/g,
    replacement: "bg-[var(--accent)]",
  },
  {
    id: "text-teal-600-dark-teal-400",
    pattern: /text-teal-600\s+dark:text-teal-400/g,
    replacement: "text-[var(--accent)]",
  },
  {
    id: "text-teal-700-dark-teal-300",
    pattern: /text-teal-700\s+dark:text-teal-300/g,
    replacement: "text-[var(--accent)]",
  },
  {
    id: "border-teal-600-dark-teal-400",
    pattern: /border-teal-600\s+dark:border-teal-400/g,
    replacement: "border-[var(--accent)]",
  },
  // ── Decorative gradients (ADR-068 enforcement) ─────────────────────────────
  // Gradientes teal/emerald/green → accent brand. Otros decorativos → surface.
  // Consume from-X-N via-X-N to-X-N completo en una sola regla.
  {
    id: "gradient-teal-accent",
    pattern: /bg-(gradient|linear)-to-[a-z]+\s+from-(teal|emerald|green)-\d{2,3}(\s+via-[a-z0-9-]+)?(\s+to-[a-z0-9-]+)?/g,
    replacement: "bg-[var(--accent)]",
  },
  {
    id: "gradient-decorative-to-sunken",
    pattern: /bg-(gradient|linear)-to-[a-z]+\s+from-(indigo|violet|purple|pink|fuchsia|rose|red|orange|yellow|amber|cyan|sky|blue|slate)-\d{2,3}(\s+via-[a-z0-9-]+)?(\s+to-[a-z0-9-]+)?/g,
    replacement: "bg-[var(--surface-sunken)]",
  },
  {
    id: "gradient-legacy-prefix-standalone",
    pattern: /(?<![\w-])bg-gradient-to-[a-z]+(?!\w)(?!\s+from-)/g,
    replacement: "bg-[var(--surface-sunken)]",
  },
];
