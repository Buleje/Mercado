// Captura screenshots del superadmin post Ola 2 (topbar + security + health).
// Variante del visual-verify-superadmin.mjs con OUT distinto y PAGES focalizadas.
import { chromium } from "playwright";
import { mkdir } from "node:fs/promises";
import { existsSync, readFileSync } from "node:fs";

const BASE = "http://localhost:3000";
const OUT = "reports/visual-verify/2026-04-17-superadmin-ola2-post";
...
const PAGES = [
  ...
  { name: "03-health",   url: "/superadmin/health" },
  { name: "04-dashboard",url: "/superadmin/dashboard" },
  { name: "05-setup",    url: "/superadmin/setup" },
];
