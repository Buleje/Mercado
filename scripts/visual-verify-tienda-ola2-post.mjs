// Screenshots post Ola 2 — verifica badges unificados + precio canonico + 0 podium borders.
...
const SLUG = "main";
const OUT = "reports/visual-verify/2026-04-17-tienda-ola2-post";
...
async function main() {
  ...
  // Snapshots 2-6: scroll progresivo — focus en zonas que tocó Ola 2
  ...
  await browser.close();
  console.log("OK — screenshots Ola 2 post en", OUT);
}
