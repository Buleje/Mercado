            ...
            <div className="flex flex-1 flex-col gap-3 p-5">
              <div className="flex items-start justify-between gap-2">
                <div>
                  ...
                  <div className="mt-1 flex items-baseline gap-1">
                    <span className="text-xs font-semibold text-[var(--text-secondary)] dark:text-gray-400">S/</span>
                    ...
                    {card.balance !== card.amount && (
                      <span className="ml-1 text-xs text-[var(--text-tertiary)] line-through dark:text-gray-500">
              ...
              {isActive && (
                <div>
                  ...
                  <p className="mt-1 text-[length:var(--ts-2xs)] text-[var(--text-secondary)] dark:text-gray-400">
...
function Row({
  ...
  return (
    <div className="flex items-center justify-between gap-2">
      <dt className="flex items-center gap-1.5 text-[var(--text-secondary)] dark:text-gray-400">
        <Icon className="h-3 w-3" aria-hidden="true" />
        {label}
      </dt>
      <dd className="truncate font-medium text-[var(--text-primary)] dark:text-gray-300">{value}</dd>
    </div>
  );
}
