            ...
            <div className="flex-1 text-center sm:text-left">
              ...
              {deferredPrompt ? (
                <button
                  ...
                  className="inline-flex items-center gap-2 bg-white text-[#0f766e] font-bold px-6 py-3 rounded-xl hover:bg-white/90 active:scale-95 transition-all shadow-lg"
                >
