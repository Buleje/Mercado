  ...
  return (
    <div className="space-y-3 sm:space-y-6">
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-16 text-gray-400 bg-white dark:bg-card rounded-xl border border-dashed border-[var(--rule-base)] dark:border-card-border">
            ...
            return (
              <div key={k.id} className="bg-white dark:bg-card rounded-xl border border-[var(--rule-base)] dark:border-card-border p-4 relative group">
                ...
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <p className="text-[length:var(--ts-2xs)] font-bold text-gray-500 dark:text-muted">{k.category}</p>
                </div>
                ...
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="text-[length:var(--ts-2xs)] text-gray-400 shrink-0">{fmt(k.target, k.unit)}</span>
                </div>

                <p className="text-[length:var(--ts-2xs)] text-gray-400 font-mono mt-1 truncate">{k.formula}</p>
                <p className="text-[length:var(--ts-2xs)] text-gray-300 dark:text-gray-600 mt-0.5">{k.period}</p>
              </div>
            );
          })}
        </div>
