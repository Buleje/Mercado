    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap gap-3 items-center">
        <input
          ...
          className="flex-1 min-w-[200px] px-3 py-2 rounded-lg border border-[var(--rule-base)] dark:border-card-border bg-white dark:bg-card text-sm text-gray-900 dark:text-white placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#00B4A6]"
        />
        <div className="flex items-center gap-1.5">
          <span className="text-[length:var(--ts-xs)] text-gray-400 uppercase font-bold">Ordenar:</span>
              ...
              <table className="w-full min-w-[640px] text-sm">
                <thead>
                  <tr className="bg-gray-50 dark:bg-white/5 border-b border-[var(--rule-soft)] dark:border-card-border">
                    <th className="px-4 py-3 text-left text-[length:var(--ts-xs)] font-bold uppercase text-gray-400">Proveedor</th>
                    <th className="px-4 py-3 text-center text-[length:var(--ts-xs)] font-bold uppercase text-gray-400 hidden sm:table-cell">Prods.</th>
                    <th className="px-4 py-3 text-right text-[length:var(--ts-xs)] font-bold uppercase text-gray-400 hidden md:table-cell">Precio prom.</th>
                    <th className="px-4 py-3 text-center text-[length:var(--ts-xs)] font-bold uppercase text-gray-400 hidden sm:table-cell">Tiempo</th>
                    <th className="px-4 py-3 text-left text-[length:var(--ts-xs)] font-bold uppercase text-gray-400 hidden lg:table-cell">Pago</th>
                    <th className="px-4 py-3 text-center text-[length:var(--ts-xs)] font-bold uppercase text-gray-400">Score</th>
                    <th className="px-4 py-3 text-center text-[length:var(--ts-xs)] font-bold uppercase text-gray-400">OC</th>
                  </tr>
                </thead>
                    ...
                    >
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            ...
                            {s.categoria && (
                              <p className="text-[length:var(--ts-2xs)] text-gray-400 dark:text-muted">{s.categoria}</p>
                            )}
                          </div>
                        </div>
                      </td>
                      ...
                      <td className="px-4 py-3 text-center">
                        <div className="flex flex-col items-center gap-1">
                          ...
                          <span className="text-[length:var(--ts-2xs)] font-bold text-gray-500 dark:text-muted">{s.score.toFixed(0)}pts</span>
                        </div>
                      </td>
                      <td className="px-4 py-3 text-center">
                        <button
                          onClick={e => { e.stopPropagation(); handleCreateOC(s); }}
                          className="flex items-center gap-1 px-2 py-1.5 rounded-lg text-[length:var(--ts-2xs)] font-bold text-[#00B4A6] bg-[#00B4A6]/10 hover:bg-[#00B4A6]/20 transition-colors min-h-[32px]"
