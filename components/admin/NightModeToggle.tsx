    ...
    <div className="space-y-5">
      ...
      <div
        className={cn(
          ...
          nightActive
            ? "border-indigo-300 dark:border-indigo-700 bg-[var(--surface-sunken)]"
      ...
      >
        <div
          className={cn(
            ...
            nightActive
              ? "bg-indigo-600 dark:bg-[var(--surface-sunken)]"
            ...
            <button
              ...
              className={cn(
                ...
                prefs.override === value
                  ...
                  : "border-[var(--rule-base)] text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-750"
              )}
            >
      ...
      {/* Horario configurado */}
      <div className="rounded-xl border border-[var(--rule-base)] bg-gray-50 dark:bg-gray-800/60 p-4">
