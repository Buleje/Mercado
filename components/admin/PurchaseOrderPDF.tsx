...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    /* Header */
    .header { display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 32px; padding-bottom: 24px; border-bottom: 3px solid #0f766e; }
    .brand-name { font-size: 24px; font-weight: 900; color: #0f766e; }
    .brand-sub  { font-size: 11px; color: #6b7280; margin-top: 2px; }
    .brand-info { font-size: 11px; color: #6b7280; margin-top: 4px; line-height: 1.5; }
    .oc-badge   { background: #0f766e; color: #fff; font-size: 22px; font-weight: 900; padding: 10px 20px; border-radius: 10px; text-align: right; }
    ...
    .totals-row.total { border-top: 2px solid #0f766e; margin-top: 8px; padding-top: 8px; font-size: 16px; font-weight: 900; color: #0f766e; }
