    ...
    <div className="flex flex-col gap-3 text-sm">
      ...
      <div className="relative rounded-lg border border-[var(--rule-base)] bg-[var(--surface-sunken)]/50 overflow-hidden">
        ...
        <div className="absolute inset-0 grid grid-cols-2 grid-rows-2">
          <div className="bg-primary/10 dark:bg-primary/15 border-r border-b border-dashed border-[var(--rule-base)] " />
          <div className="bg-primary/10 dark:bg-primary/15 border-b border-dashed border-[var(--rule-base)] " />
          <div className="bg-[var(--data-error-50)]/30 dark:bg-[var(--data-error-500)]/10 border-r border-dashed border-[var(--rule-base)] " />
