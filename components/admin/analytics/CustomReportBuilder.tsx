    ...
    <div
      className={cn(
        ...
        current === step
          ...
          : current > step
          ? "bg-[#2d6a4f]/30 text-[#2d6a4f] dark:text-[#52b788]"
        ...
        {[1, 2, 3].map((s) => (
          <div key={s} className="flex items-center gap-1.5">
            <button onClick={() => setStep(s)} className="flex items-center gap-1.5">
              ...
              <span className={cn(
                "text-xs font-medium",
                step === s ? "text-[#2d6a4f] dark:text-[#52b788]" : "text-gray-500 dark:text-gray-400"
              )}>
      ...
      {step === 1 && (
        <div className="flex flex-col gap-3">
              ...
              <label
                ...
                className={cn(
                  ...
                  selectedMetrics.includes(key)
                    ? "bg-[#2d6a4f]/10 dark:bg-[#2d6a4f]/20 border-[#2d6a4f]/40 text-[#2d6a4f] dark:text-[#52b788]"
                    : "bg-white dark:bg-card border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300 hover:border-[#2d6a4f]/40"
                )}
              >
                <input
                  type="checkbox"
          ...
          <button
            ...
            className="mt-2 px-4 py-2 rounded-lg bg-[#2d6a4f] text-white text-sm font-medium hover:bg-[#245a41] disabled:opacity-50 transition-colors"
          >
            Siguiente: Periodo
          </button>
        </div>
      ...
      {step === 2 && (
        <div className="flex flex-col gap-3">
              ...
              <button
                ...
                className={cn(
                  ...
                  grouping === key
                    ...
                    : "text-gray-600 dark:text-gray-400 border-gray-200 dark:border-gray-700 hover:border-[#2d6a4f]"
                )}
              >
                {label}
              </button>
          ...
          <div className="flex gap-2 mt-2">
            ...
            <button
              onClick={() => setStep(3)}
              className="flex-1 px-3 py-2 rounded-lg bg-[#2d6a4f] text-white text-sm font-medium hover:bg-[#245a41] transition-colors"
            >
              Siguiente: Filtros
            </button>
          </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <button
              ...
              className="px-3 py-1.5 rounded-lg bg-[#f4a261] text-white text-xs font-medium hover:bg-[#e8923d] disabled:opacity-50 transition-colors"
            >
              Exportar CSV
            </button>
            <button
              ...
              className="px-3 py-1.5 rounded-lg bg-[#2d6a4f] text-white text-xs font-medium hover:bg-[#245a41] disabled:opacity-50 transition-colors"
            >
            ...
            {templates.map((t) => (
              ...
              >
                ...
                <button
                  ...
                  className="px-2 py-1 rounded text-[10px] font-medium text-[#2d6a4f] dark:text-[#52b788] border border-[#2d6a4f]/30 hover:bg-[#2d6a4f]/10 transition-colors"
                >
                  Cargar
                </button>
                <button
