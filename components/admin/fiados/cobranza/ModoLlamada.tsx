...
/**
 * La ronda de cobranza, un cliente a la vez — port de ModoLlamada.tsx
 * (Adelantos). Es la pantalla del rato de cobrar, no la del análisis.
 */
...
export default function ModoLlamada({
  ...
  onGestionRapida: (customerId: string, tipo: string) => Promise<void>;
  onClose: () => void;
}) {
  ...
  const wa = waLink(d.telefono, mensajeDe(d));
      ...
      <div className="min-h-0 flex-1 overflow-y-auto px-6">
        <div className="mx-auto flex max-w-2xl flex-col items-center gap-5 py-6 text-center">
          ...
          <div>
            ...
            <p className="mt-1 text-xl tabular-nums text-[var(--text-secondary)]">{d.telefono}</p>
          </div>
