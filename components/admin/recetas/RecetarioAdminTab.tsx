  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap gap-3 text-xs">
        <div className="flex items-center gap-1.5 bg-emerald-50 text-emerald-700 px-3 py-1.5 rounded-lg font-bold">
        ...
        <div className="flex items-center gap-1.5 bg-amber-50 text-amber-700 px-3 py-1.5 rounded-lg font-bold">
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-[var(--rule-soft)] text-left">
                  ...
                  <th className="px-4 py-3 font-semibold text-gray-500 text-right">Costo</th>
                  <th className="px-4 py-3 font-semibold text-gray-500 text-center">Estado</th>
              ...
              <tbody>
                {filtered.map(r => (
                  <tr key={r._noteId || r.id} className="border-b border-gray-50 hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-4 py-3 text-center text-gray-600 hidden md:table-cell">{r.ingredientes?.length || 0}</td>
                    <td className="px-4 py-3 text-right font-bold text-gray-900">{formatCurrency(r.totalIngredientes || 0)}</td>
          ...
          <>
            ...
            <m.div key="del-modal" initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.95 }} className="fixed inset-0 z-50 flex items-center justify-center p-4">
              <div className="bg-white rounded-xl p-6 max-w-sm w-full space-y-4">
                <p className="text-base font-bold text-gray-900">Eliminar receta?</p>
                <p className="text-sm text-gray-500">Esta accion no se puede deshacer. La receta se eliminara del recetario publico.</p>
                <div className="flex gap-2">
                  <button onClick={() => setDeleteConfirm(null)} className="flex-1 px-4 py-2.5 rounded-lg text-sm font-bold bg-gray-100 text-gray-600 hover:bg-gray-200 transition-colors">Cancelar</button>
              ...
              <div className="w-full max-w-2xl bg-white border border-[var(--rule-base)] rounded-xl max-h-[90vh] flex flex-col">
                ...
                <div className="flex-1 overflow-y-auto px-5 py-4 space-y-4">
                  ...
                  {modalTab === "ingredientes" && (
                    <div className="space-y-3">
                      <div className="flex items-center justify-between">
                        <p className="text-sm font-bold text-gray-900">Ingredientes ({ingredientes.length})</p>
                  ...
                  {modalTab === "pasos" && (
                    <div className="space-y-3">
                      <div className="flex items-center justify-between">
                        <p className="text-sm font-bold text-gray-900">Pasos de preparacion ({pasos.filter(p => p.trim()).length})</p>
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="bg-white border border-[var(--rule-base)] rounded-xl overflow-hidden ">
                        ...
                        <div className="p-4 space-y-3">
                          ...
                          {ingredientes.length > 0 && (
                            <div>
                              <p className="text-xs font-bold text-gray-900 mb-2">Ingredientes</p>
                          ...
                          {pasos.filter(p => p.trim()).length > 0 && (
                            <div>
                              <p className="text-xs font-bold text-gray-900 mb-2">Preparacion</p>
