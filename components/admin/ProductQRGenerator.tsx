            ...
            <>
              ...
              <div className="flex flex-wrap justify-center gap-2">
                ...
                <button
                  ...
                  disabled={rendering}
                  className="flex items-center gap-2 rounded-lg border border-primary px-4 py-2 text-sm font-semibold text-primary transition hover:bg-primary/5 disabled:opacity-50 dark:text-emerald-400"
                >
