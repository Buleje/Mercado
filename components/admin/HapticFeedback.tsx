  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex items-center gap-2">
        <Vibrate className="w-5 h-5 text-[#2d6a4f]" />
      ...
      <div
        className={cn(
          ...
          haptic.enabled
            ? "border-[#2d6a4f]/40 bg-[#2d6a4f]/5 dark:bg-[#2d6a4f]/10"
            : "border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800"
        )}
      >
        <div className="flex items-center gap-3">
          {haptic.enabled ? (
            <Volume2 className="w-6 h-6 text-[#2d6a4f] dark:text-[#52b788] shrink-0" />
          ) : (
        ...
        <button
          ...
          className={cn(
            "relative w-12 h-6 rounded-full transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-[#2d6a4f] focus:ring-offset-2",
            haptic.enabled
          ...
          {patterns.map(({ key, label, desc, fn }) => (
            <button
              ...
              className={cn(
                ...
                lastTest === label
                  ? "border-[#2d6a4f] bg-[#2d6a4f]/10 scale-95"
                  : "border-gray-200 dark:border-gray-700 hover:border-[#2d6a4f]/40 hover:bg-gray-50 dark:hover:bg-gray-750",
            ...
            >
              <div className="flex items-center justify-between mb-1">
                ...
                {lastTest === label && (
                  <Check className="w-3.5 h-3.5 text-[#2d6a4f] dark:text-[#52b788]" />
                )}
              </div>
      ...
      <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/60 p-4 space-y-3">
        ...
        <div className="space-y-2 text-xs font-mono text-gray-600 dark:text-gray-400">
          <div className="rounded-lg bg-gray-100 dark:bg-gray-700 px-3 py-2">
            ...
            <p className="text-[#2d6a4f] dark:text-[#52b788]">{"import { useHaptic } from './HapticFeedback';"}</p>
          ...
          <div className="rounded-lg bg-gray-100 dark:bg-gray-700 px-3 py-2">
            ...
            <p className="text-[#2d6a4f] dark:text-[#52b788]">{"import { HapticWrapper } from './HapticFeedback';"}</p>
