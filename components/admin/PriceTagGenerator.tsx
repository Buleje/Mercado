              ...
              <button
                ...
                className={cn(
                  ...
                  format === f
                    ...
                    : "border-[var(--rule-base)] text-gray-600 hover:border-[#00B4A6]/40 dark:border-gray-600 dark:text-gray-300"
                )}
              >
            ...
            <div className="rounded-xl border border-[var(--rule-base)] bg-gray-50 p-4 dark:border-[var(--rule-base)] dark:bg-gray-800/50">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                {selectedList.length > 6 && (
                  <div
                    className="flex items-center justify-center rounded border border-dashed border-[var(--rule-base)] bg-gray-100 text-xs text-gray-400 dark:border-gray-600 dark:bg-gray-800"
                    style={{
