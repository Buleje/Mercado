  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-xl border border-gray-200 bg-white p-5 dark:border-gray-700 dark:bg-gray-900">
        ...
        {/* Result */}
        <div className="mt-5 flex items-center justify-between rounded-xl bg-[#2d6a4f]/10 px-5 py-4 dark:bg-[#2d6a4f]/20">
          <div>
            ...
            <p className="text-3xl font-bold text-[#2d6a4f]">{fmt(total)}</p>
          </div>
          <button
            onClick={handleAddToCart}
            disabled={w <= 0 || ppkg <= 0 || !product.trim()}
            className="flex items-center gap-2 rounded-xl bg-[#f4a261] px-5 py-3 font-semibold text-white transition hover:bg-[#e08c4a] disabled:opacity-40"
          >
      ...
      <div className="rounded-xl border border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-900">
        <div className="flex items-center justify-between border-b border-gray-100 p-4 dark:border-gray-800">
          ...
          <span className="rounded-full bg-[#2d6a4f]/10 px-3 py-1 text-sm font-bold text-[#2d6a4f]">
          ...
          <div className="divide-y divide-gray-100 dark:divide-gray-800">
            {history.map((e) => (
              ...
              >
                ...
                <span className="font-bold text-[#2d6a4f]">{fmt(e.total)}</span>
                <button
