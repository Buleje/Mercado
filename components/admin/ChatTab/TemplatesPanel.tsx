        ...
        <div className="mt-2 space-y-1.5 border-t border-[var(--rule-base)] pt-2 dark:border-[var(--rule-base)]">
          ...
          <div className="flex gap-1.5">
            ...
            <button
              ...
              className="rounded-xl border border-[var(--rule-base)] px-3 min-h-10 text-sm font-semibold text-[var(--text-tertiary)] hover:bg-[var(--surface-sunken)] dark:hover:bg-[var(--surface-sunken)]"
            >
              Cancelar
            </button>
          </div>
