      ...
      >
        ...
        <div className="flex flex-col items-center gap-3 mb-6">
          <div className="w-14 h-14 rounded-full bg-[#2d6a4f]/10 flex items-center justify-center">
            <Lock size={26} className="text-[#2d6a4f]" />
          </div>
          ...
          <>
                ...
                <button
                  ...
                  className={cn(
                    ...
                    key === ""
                      ...
                      : "bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-white hover:bg-[#2d6a4f]/10 hover:text-[#2d6a4f] dark:hover:bg-[#2d6a4f]/20 active:scale-95",
            ...
            <button
              ...
              className={cn(
                ...
                "bg-[#2d6a4f] hover:bg-[#235c42] active:scale-[0.98]",
                "disabled:opacity-40 disabled:cursor-not-allowed"
              )}
            >
