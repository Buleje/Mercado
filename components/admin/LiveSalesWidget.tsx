      ...
      <div className="flex items-center gap-4">
        ...
        {data.goal > 0 && (
          <div className="relative shrink-0">
            ...
            <span className="absolute inset-0 flex items-center justify-center text-[length:var(--ts-2xs)] font-bold text-gray-600 dark:text-gray-300">
              {goalPct.toFixed(0)}%
            </span>
          </div>
        )}
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-baseline gap-1.5">
            <span className={cn(
              "text-xl font-extrabold text-gray-900 dark:text-foreground transition-colors",
          ...
          <p className="text-[length:var(--ts-xs)] text-gray-400 mt-0.5">Ventas hoy</p>
        </div>
        ...
        <div className="flex gap-4 shrink-0">
          <div className="text-center">
            ...
            <p className="text-[length:var(--ts-2xs)] text-gray-400">pedidos</p>
          </div>
          <div className="text-center">
            <div className="flex items-center justify-center gap-1">
