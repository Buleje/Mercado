      ...
      <div className="max-h-[92dvh] w-full overflow-y-auto rounded-t-2xl border border-[var(--rule-base)] bg-[var(--surface-raised)] shadow-xl sm:max-w-lg sm:rounded-2xl">
        ...
        <div className="space-y-4 p-6">
          ...
          <div className="grid grid-cols-2 gap-2">
            <button type="button" onClick={() => setDirAndType("in")} className={cn("flex items-center justify-center gap-2 rounded-xl border-2 px-3 min-h-11 text-sm font-semibold transition-colors", dir === "in" ? "border-[var(--accent)] bg-primary/10 text-[var(--accent-ink)] dark:text-[var(--accent)]" : "border-[var(--rule-base)] text-[var(--text-secondary)] hover:bg-[var(--surface-sunken)]")}><ArrowUpCircle className="h-4 w-4" /> Entrada</button>
            <button type="button" onClick={() => setDirAndType("out")} className={cn("flex items-center justify-center gap-2 rounded-xl border-2 px-3 min-h-11 text-sm font-semibold transition-colors", dir === "out" ? "border-[var(--data-warning-500)] bg-[var(--data-warning-100)] text-[var(--data-warning-600)] dark:bg-amber-950/30 dark:text-[var(--data-warning-500)]" : "border-[var(--rule-base)] text-[var(--text-secondary)] hover:bg-[var(--surface-sunken)]")}><ArrowDownCircle className="h-4 w-4" /> Salida</button>
          </div>
