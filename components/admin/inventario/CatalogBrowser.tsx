    ...
    <div className="bg-gray-50 dark:bg-surface rounded-xl p-3 space-y-2.5">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="h-7 w-7 rounded-lg flex items-center justify-center text-red-400 hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-950/20 transition-colors shrink-0"
        >
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          <h3 className="text-base font-extrabold text-foreground">Catalogo de Abarrotes Peruanos</h3>
            ...
            <div className="border-t border-gray-200 dark:border-card-border">
              ...
              <div className="border-t border-gray-200 dark:border-card-border px-5 py-4 bg-gray-50 dark:bg-surface">
                ...
                <div className="flex items-center justify-between gap-3">
                  <button onClick={() => setCart([])} className="text-xs font-semibold text-red-500 hover:underline">
                    Vaciar carrito
                  </button>
                  <button
                ...
                {result && (
                  <div className="flex items-center gap-2 mt-3 p-3 rounded-xl bg-emerald-50 dark:bg-emerald-950/30">
                    <Check className="h-5 w-5 text-emerald-600 shrink-0" />
                    <span className="text-sm text-emerald-700 dark:text-emerald-400 font-bold">
