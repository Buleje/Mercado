...
/**
 * Salto entre módulos del panel: recarga el módulo destino entero.
 *
 * Sólo se usa cuando este resumen vive suelto. Dentro de «Mi Plata» los tres
 * destinos son secciones hermanas —están a un clic en la barra de arriba— y
 * remontar el módulo para llegar sería el camino largo a la puerta de al lado:
 * ahí el padre pasa `onIr` y el cambio es instantáneo.
 */
