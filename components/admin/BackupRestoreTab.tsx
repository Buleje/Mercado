                    ...
                    <div className="flex flex-wrap items-center justify-between gap-3">
                      ...
                      <div className="flex items-center gap-1 shrink-0">
                        ...
                        <button onClick={() => handleDelete(b.id)}
                          className="p-1.5 rounded-lg hover:bg-red-50 dark:hover:bg-red-950/20 text-gray-400 hover:text-red-500" title="Eliminar">
          ...
          <div className="space-y-2">
            ...
            {Object.entries(SCHEDULE).map(([k, v]) => (
              <div key={k} className="flex items-center justify-between py-2 px-3 rounded-xl bg-gray-50 dark:bg-surface">
                <span className="text-sm font-semibold text-gray-700 dark:text-foreground">{k}</span>
                <span className="text-xs text-gray-500 dark:text-muted font-mono">{v}</span>
              </div>
            ))}
          </div>
