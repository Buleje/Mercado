...
const CLASS_STYLES: Record<"A" | "B" | "C", { badge: string; row: string; label: string; border: string; variant: BadgeVariant }> = {
  A: { badge: "bg-[var(--data-success-500)]/12 text-[var(--data-success-700)] dark:text-[var(--data-success-500)] dark:bg-primary/15 dark:text-[var(--data-success-500)]", row: "bg-primary/10/30 dark:bg-primary/15", label: "A — Critico", border: "border-l-4 border-l-green-500", variant: "success" },
