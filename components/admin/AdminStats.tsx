    ...
    <div className="sm:hidden flex items-center gap-1 px-2.5 py-1.5 bg-white dark:bg-card border-b border-[var(--rule-soft)] dark:border-card-border overflow-x-auto scrollbar-none text-[length:var(--ts-xs)]">
      <button
        ...
        className={cn(
          ...
          quickStats.pendingOrders > 0 ? "bg-[var(--data-warning-100)] text-[var(--data-warning)]" : "bg-gray-100 text-[var(--text-secondary)]"
        )}
      >
      ...
      <span className="flex items-center gap-1 px-2 py-1 rounded-full bg-[var(--accent-soft)] text-[var(--data-success)] font-semibold shrink-0">
      ...
      {quickStats.lowStockProducts > 0 && (
        <>
          ...
          <button
            ...
            className="flex items-center gap-1 px-2 py-1 rounded-full bg-[var(--data-error-100)] text-[var(--data-error)] font-semibold shrink-0 transition-colors"
          >
      ...
      {(quickStats.overduePayables ?? 0) > 0 && (
        <>
          ...
          <button
            ...
            className="flex items-center gap-1 px-2 py-1 rounded-full bg-[var(--data-warning-100)] text-[var(--data-warning)] font-semibold shrink-0 transition-colors"
          >
...
export function AdminStatsDesktop({ quickStats, navigateTab }: AdminStatsProps) {
  return (
    <div className="hidden sm:flex items-center gap-1 px-6 py-1.5 bg-white dark:bg-card border-b border-[var(--rule-soft)] dark:border-card-border text-xs">
      <button
        ...
        className={cn(
          ...
          quickStats.pendingOrders > 0
            ? "bg-[var(--data-warning-100)] text-[var(--data-warning)] hover:bg-[var(--data-warning)]"
      ...
      <span className="flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-[var(--accent-soft)] text-[var(--data-success)] font-semibold">
      ...
      {quickStats.lowStockProducts > 0 && (
        <>
          ...
          <button
            onClick={() => navigateTab("inventario")}
            className="flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-[var(--data-error-100)] text-[var(--data-error)] font-semibold hover:bg-[var(--data-error)] transition-colors"
          >
      ...
      {(quickStats.overduePayables ?? 0) > 0 && (
        <>
          ...
          <button
            onClick={() => navigateTab("plata" as Tab)}
            className="flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-[var(--data-warning-100)] text-[var(--data-warning)] font-semibold hover:bg-[var(--data-warning)] transition-colors"
          >
