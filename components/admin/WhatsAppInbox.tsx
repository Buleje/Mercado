        ...
        <div className="flex items-center justify-between border-b border-gray-200 px-4 py-3 dark:border-gray-700">
          <div className="flex items-center gap-2">
            ...
            {conversations.reduce((s, c) => s + c.unread, 0) > 0 && (
              <span className="rounded-full bg-[#2d6a4f] px-2 py-0.5 text-xs font-bold text-white">
        ...
        <div className="flex-1 overflow-y-auto">
          {loadingConvs ? (
            ...
            <div className="px-4 py-8 text-center">
              ...
              <button
                onClick={fetchConversations}
                className="mt-2 text-xs text-[#2d6a4f] underline"
              >
                Reintentar
              </button>
            </div>
            ...
            filtered.map((conv) => (
              ...
              >
                {/* Avatar */}
                <div className="flex h-11 w-11 min-w-[44px] items-center justify-center rounded-full bg-[#2d6a4f] text-sm font-bold text-white">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="flex items-center justify-between gap-1">
                    ...
                    {conv.unread > 0 && (
                      <span className="flex h-5 min-w-[20px] items-center justify-center rounded-full bg-[#2d6a4f] px-1 text-[11px] font-bold text-white">
            ...
            <div className="border-t border-gray-200 px-4 py-3 dark:border-gray-700">
              <div className="flex items-end gap-2">
                <textarea
                  ...
                  rows={1}
                  maxLength={500}
                  className="min-h-[44px] flex-1 resize-none rounded-xl border border-gray-200 bg-gray-50 px-4 py-2.5 text-sm text-gray-800 outline-none transition focus:border-[#2d6a4f] focus:ring-1 focus:ring-[#2d6a4f] dark:border-gray-600 dark:bg-gray-800 dark:text-gray-100 dark:placeholder:text-gray-500"
                  style={{ maxHeight: "120px", overflowY: "auto" }}
                />
                <button
                  onClick={sendMessage}
                  disabled={!inputMsg.trim() || sending}
                  className="flex min-h-[44px] min-w-[44px] items-center justify-center rounded-xl bg-[#2d6a4f] text-white transition hover:bg-[#245a42] disabled:cursor-not-allowed disabled:opacity-50"
