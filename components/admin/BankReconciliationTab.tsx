...
const STATUS_META: Record<ReconciliationStatus, { label: string; color: string; bg: string; icon: typeof CheckCircle }> = {
  conciliado:   { label: "Conciliado",    color: "text-[var(--data-success-500)] dark:text-[var(--data-success-500)]", bg: "bg-primary/10 dark:bg-primary/15", icon: CheckCircle },
  ...
  return (
    <div className="space-y-3 sm:space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-6 gap-3">
        {[
          { label: "Conciliados", value: String(stats.conciliados), color: "text-[var(--data-success-500)]", bg: "bg-primary/10 dark:bg-primary/15" },
          ...
          { label: "Total ingresos", value: fmt(stats.ingresos), color: "text-[var(--data-success-500)]", bg: "bg-primary/10 dark:bg-primary/15" },
                ...
                return (
                  <tr key={m.id} className="hover:bg-[var(--surface-alt)]/50 dark:hover:bg-surface/30 transition-colors">
                    ...
                    <td className="px-2 sm:px-4 py-2 sm:py-3 text-center">
                      <span className={cn("text-xs font-bold px-2 py-0.5 rounded-full", m.type === "ingreso" ? "bg-[var(--data-success-500)]/12 text-[var(--data-success-700)] dark:text-[var(--data-success-500)] dark:bg-primary/15 dark:text-[var(--data-success-500)]" : "bg-[var(--data-error-100)] text-[var(--data-error-500)] dark:bg-[var(--data-error-500)]/30 dark:text-[var(--data-error-500)]")}>
                    ...
                    <td className="px-2 sm:px-4 py-2 sm:py-3">
                      <div className="flex flex-wrap gap-1">
                        {m.status !== "conciliado" && (
                          <button onClick={() => reconcile(m.id)} title="Marcar conciliado" className="p-1.5 rounded-lg text-[var(--text-tertiary)] hover:text-[var(--data-success-500)] hover:bg-primary/10 dark:hover:bg-primary/15">
                            <Link2 className="h-3.5 w-3.5" />
                          </button>
                        )}
                        <button onClick={() => setDetail(m)} className="p-1.5 rounded-lg text-[var(--text-tertiary)] hover:text-[var(--data-success-500)] hover:bg-primary/10 dark:hover:bg-primary/15">
