...
export default function WaCustomerCard({ context }: { context: WaCustomerContext | null }) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-2 border-b border-[var(--rule-base)] bg-[var(--surface-raised)] px-4 py-2 ">
      {!isKnown ? (
        <span className="inline-flex items-center gap-1.5 text-[length:var(--ts-xs)] font-semibold text-[var(--text-tertiary)]">
