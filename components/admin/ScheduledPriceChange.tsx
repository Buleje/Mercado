...
function AddForm({ onAdd, onCancel }: AddFormProps) {
  ...
  return (
    <div className="rounded-xl border border-[#2d6a4f]/30 bg-[#2d6a4f]/5 dark:bg-[#2d6a4f]/10 dark:border-[#2d6a4f]/40 p-5 space-y-4">
      ...
      <div className="relative">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-2 text-sm rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-[#2d6a4f]/40"
          />
          {searching && (
            <div className="absolute right-3 top-1/2 -translate-y-1/2 w-3 h-3 border border-[#2d6a4f] border-t-transparent rounded-full animate-spin" />
          )}
        </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <div>
          <label className="block text-xs font-medium text-gray-600 dark:text-gray-400 mb-1">
            Precio nuevo
            {priceDiff !== null && (
              <span className={cn("ml-2 font-semibold", isIncrease ? "text-red-500" : "text-[#2d6a4f]")}>
          ...
          <div className="flex items-center gap-1">
            ...
            <input
              ...
              placeholder="0.00"
              className="w-full px-2 py-2 text-sm rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-[#2d6a4f]/40"
            />
          </div>
        </div>
      </div>
      ...
      <div className="flex items-center justify-end gap-2 pt-1">
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-4 py-2 text-sm font-medium rounded-lg bg-[#2d6a4f] hover:bg-[#235c42] text-white transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
        >
          <Check size={14} />
          Programar cambio
        </button>
    ...
    <div className="space-y-5">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-4 py-2 text-sm font-medium rounded-lg bg-[#2d6a4f] hover:bg-[#235c42] text-white transition-colors"
        >
          <Plus size={14} />
          Programar
        </button>
              ...
              <div className="flex items-start justify-between gap-3">
                <div className="min-w-0">
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    <span className={cn("text-xs font-semibold", isIncrease ? "text-red-500" : "text-[#2d6a4f]")}>
