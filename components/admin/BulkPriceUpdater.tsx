          ...
          {mode === "percent" && (
            <div className="rounded-xl border border-[var(--rule-base)] bg-[var(--surface-raised)] p-6 space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <Field label="Categoria" labelClassName="text-xs font-medium text-[var(--text-secondary)]" className="space-y-1">
                  <select
                ...
                <Field label="Accion" labelClassName="text-xs font-medium text-[var(--text-secondary)]" className="space-y-1">
                  <select
                    value={direction}
                ...
                <Field label="Porcentaje" labelClassName="text-xs font-medium text-[var(--text-secondary)]" className="space-y-1">
                  {(id) => (
