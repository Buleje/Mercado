                  ...
                  <tbody className="divide-y divide-[var(--rule-soft)]">
                    {filteredArchive.map(o => (
                      ...
                      >
                        ...
                        <td className="px-4 py-3 font-semibold text-primary">{formatCurrency(Number(o.total))}</td>
                  ...
                  >
                    <div className="flex justify-between items-start gap-3">
                      ...
                      <div className="shrink-0 text-right">
                        ...
                        <p className="text-sm font-bold text-primary mt-1">{formatCurrency(Number(o.total))}</p>
                      </div>
                    </div>
