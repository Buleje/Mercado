...
export function OrdersBulkActions({
  ...
  return (
    <div className="fixed bottom-0 inset-x-0 rounded-none sm:bottom-4 sm:left-1/2 sm:inset-x-auto sm:-translate-x-1/2 sm:rounded-xl z-40 bg-[var(--text-primary)] text-[var(--surface-canvas)] px-4 sm:px-5 py-3 flex flex-wrap items-center justify-center gap-2 sm:gap-3 shadow-xl animate-[slideUp_0.2s_ease-out]">
