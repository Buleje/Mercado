...
import { Check, Store, User, HeartHandshake, MoreHorizontal } from "@buleje/design-system/icons";
...
export default function ManualDeliveryModal({
  ...
  return (
    ...
    >
            ...
            {METHODS.map((m) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    "flex items-center gap-2.5 px-3 h-10 rounded-xl border-2 text-sm font-semibold text-left transition-all",
                    isActive
      ...
      {/* Footer actions */}
      <div className="flex items-center gap-2 px-5 py-4 border-t border-[var(--rule-soft)] bg-[var(--surface-raised)]">
        <button
          type="button"
          onClick={onCancel}
