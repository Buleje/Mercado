  ...
  return (
    <div className="bg-white dark:bg-card rounded-2xl border border-gray-200 dark:border-card-border p-5 space-y-4">
      ...
      <div className="flex items-center gap-2">
        <TagIcon className="h-5 w-5 text-[#2d6a4f]" />
      ...
      <div className="flex flex-col sm:flex-row gap-2">
        <input
          ...
          maxLength={30}
          className="flex-1 px-3 py-2 rounded-xl border border-gray-200 dark:border-card-border bg-white dark:bg-surface text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-[#2d6a4f]/30 focus:border-[#2d6a4f]"
        />
        {/* Color picker */}
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-3 py-2 bg-[#2d6a4f] text-white rounded-xl text-sm font-semibold hover:bg-[#245a42] disabled:opacity-50 transition-colors min-h-[44px]"
        >
