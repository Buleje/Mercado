...
export default function LivesAdminModule() {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Hero CTA */}
      <div className="bg-white border-2 border-[#00B4A6]/20 rounded-2xl p-5 shadow-sm">
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          ...
          <button
            onClick={() => setShowSchedule(true)}
            className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold text-[#00B4A6] bg-[#00B4A6]/10 hover:bg-[#00B4A6]/20 transition-colors"
          >
        ...
        {scheduled.length === 0 ? (
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            {scheduled.map((s) => (
              <div
                key={s.id}
                className="bg-white border border-gray-200 rounded-2xl p-4 shadow-sm hover:border-[#00B4A6]/40 transition-colors"
              >
