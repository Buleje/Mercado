...
export default function CrecimientoHubModule({ initialTab }: { initialTab?: string } = {}) {
  ...
  return (
    <div className="space-y-4">
      ...
      <AdminTabBar
        heading={{ title: "Crecimiento", description: "Campañas, fidelización y programas para que el cliente vuelva.", icon: Megaphone }} tabs={TABS} activeTab={sub} onTabChange={setSub} moduleId={MODULE_ID}>
