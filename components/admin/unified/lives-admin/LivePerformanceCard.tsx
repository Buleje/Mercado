      ...
      <div className="grid grid-cols-4 gap-2 pt-3 border-t border-gray-100">
        <div>
          <div className="flex items-center gap-1 text-[var(--text-tertiary)] mb-0.5">
            ...
            <span className="text-[10px] uppercase tracking-wide font-bold">Views</span>
          </div>
        ...
        <div>
          <div className="flex items-center gap-1 text-[var(--text-tertiary)] mb-0.5">
            ...
            <span className="text-[10px] uppercase tracking-wide font-bold">Engage</span>
          </div>
        ...
        <div>
          <div className="flex items-center gap-1 text-[var(--text-tertiary)] mb-0.5">
            ...
            <span className="text-[10px] uppercase tracking-wide font-bold">Pedidos</span>
          </div>
        ...
        <div>
          <div className="flex items-center gap-1 text-[var(--text-tertiary)] mb-0.5">
            ...
            <span className="text-[10px] uppercase tracking-wide font-bold">Ventas</span>
          </div>
