      ...
      >
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100 sticky top-0 bg-white z-10">
          <div className="flex items-center gap-3">
            <div className="h-10 w-10 rounded-xl bg-[#00B4A6] text-white flex items-center justify-center">
        ...
        <div className="p-5 space-y-5">
          ...
          <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                onClick={copyCode}
                className="p-2 rounded-lg text-[var(--text-secondary)] hover:text-[#00B4A6] hover:bg-[#00B4A6]/10 transition-colors"
                title="Copiar código"
              >
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-3">
              ...
              <p className="text-xl font-extrabold text-[#00B4A6] mt-1">{fmt(card.balance)}</p>
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-3">
              <div className="flex items-center gap-3">
                <div className="h-9 w-9 rounded-full bg-[#00B4A6]/10 flex items-center justify-center">
            ...
            <div className="space-y-2 p-3 bg-[var(--data-info-50)] border border-[var(--data-info)] rounded-xl">
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  disabled={!newExpiry}
                  className="flex-1 py-2 rounded-lg text-xs font-semibold text-white bg-[#00B4A6] hover:bg-primary-dark disabled:opacity-50"
                >
                  Extender
                </button>
              </div>
