    ...
    <div className="fixed inset-0 z-9000 bg-black/80 flex items-center justify-center p-4">
      <div className="bg-white dark:bg-card rounded-xl w-full max-w-lg overflow-hidden">
        ...
        <div className="relative bg-black aspect-video">
          ...
          {!supported && (
            <div className="absolute inset-0 flex items-center justify-center text-amber-400 text-sm text-center p-6">
              <div>
          ...
          {!error && supported && (
            <div className="absolute inset-0 pointer-events-none flex items-center justify-center">
              <div className="w-64 h-32 border-2 border-white/60 rounded-lg relative overflow-hidden">
                <div className="absolute left-0 right-0 h-0.5 bg-red-500 shadow-[0_0_8px_rgba(239,68,68,0.8)] animate-[scanline_2s_ease-in-out_infinite]" />
              </div>
            </div>
          )}
        </div>
          ...
          <div className="flex items-center gap-2">
            {hasTorch && (
              <button
                ...
                className="p-2 rounded-lg text-gray-500 dark:text-muted hover:text-primary hover:bg-primary/10 transition-colors"
