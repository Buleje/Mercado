  ...
  return (
    <div className="absolute top-full left-0 mt-2 z-50 bg-white dark:bg-card border border-[var(--rule-base)] dark:border-card-border rounded-xl w-72 overflow-hidden">
      <div className="px-3 py-2 bg-gray-50 dark:bg-surface border-b border-[var(--rule-soft)] dark:border-card-border flex items-center justify-between">
        <span className="text-[length:var(--ts-2xs)] font-bold text-gray-500 dark:text-muted">
          Top 5 productos
        </span>
        <button
          onClick={onClose}
        ...
        <div className="flex items-stretch rounded-xl overflow-hidden border border-[var(--rule-base)] dark:border-card-border bg-white dark:bg-card ">
          ...
          >
            ...
            {lastSale && !lastSaleLoading && (
              <span className="text-[length:var(--ts-xs)] font-mono text-amber-600 dark:text-amber-400 bg-amber-50 dark:bg-amber-900/20 px-1.5 py-0.5 rounded-md">
                {fmt(lastSale.total)}
              </span>
            )}
          </button>
        ...
        <button
          ...
          className={cn(
            ...
            activePanel === "customers"
              ? "bg-[var(--surface-sunken)] border-violet-300 dark:border-violet-700 text-[var(--text-secondary)] dark:text-[var(--text-primary)]"
              : "bg-white dark:bg-card border-[var(--rule-base)] dark:border-card-border text-gray-700 dark:text-foreground hover:bg-gray-50 dark:hover:bg-surface"
          )}
        >
