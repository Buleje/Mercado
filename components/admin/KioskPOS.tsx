    ...
    <div className="flex flex-col h-screen bg-black text-white overflow-hidden select-none">
      ...
      <header className="flex items-center justify-between px-6 py-3 bg-gray-950 border-b border-gray-800 flex-shrink-0">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link
            href="/admin"
            className="px-4 py-2 rounded-lg bg-gray-800 hover:bg-gray-700 text-gray-300 text-sm font-semibold transition-colors min-h-[44px] flex items-center"
          >
            Salir
          </Link>
        </div>
          ...
          <div className="px-5 pt-4 pb-3 bg-gray-950 border-b border-gray-800 flex-shrink-0 space-y-3">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-13 pr-12 py-4 text-xl rounded-xl bg-gray-900 border-2 border-gray-700 text-white placeholder:text-gray-600 focus:outline-none focus:border-teal-500 transition-colors"
              />
              {search && (
                <button
                  type="button"
                ...
                >
                  ...
                  <div className="flex items-center gap-1 flex-shrink-0">
                    <button
                      ...
                      className="w-9 h-9 rounded-lg bg-gray-800 hover:bg-gray-700 flex items-center justify-center text-gray-300 transition-colors active:scale-90"
                    >
