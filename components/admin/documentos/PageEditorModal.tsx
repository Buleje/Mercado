      ...
      footer={
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-2">
            ...
            <button onClick={save} disabled={busy || loading || pages.length === 0} className="inline-flex items-center gap-2 rounded-xl bg-primary px-4 min-h-10 text-sm font-semibold text-white hover:bg-primary/90 disabled:opacity-50">
