  ...
  return (
    <div className="flex flex-wrap items-center gap-2 border-b-2 border-[var(--rule-base)] bg-[var(--surface-sunken)] px-3 py-2">
      <input
        ...
        className="h-9 w-48 rounded-xl border border-[var(--rule-base)] bg-[var(--surface-raised)] px-2.5 text-sm text-[var(--text-primary)] outline-none focus:border-[var(--accent)]"
      />
      ...
      <button type="button" onClick={() => mover(-1)} title="Anterior (Shift+Enter)"
        className="flex h-9 w-9 items-center justify-center rounded-lg border border-[var(--rule-base)] text-[var(--text-secondary)] hover:bg-[var(--surface-raised)]">
      ...
      <input
        ...
        className="h-9 w-44 rounded-xl border border-[var(--rule-base)] bg-[var(--surface-raised)] px-2.5 text-sm text-[var(--text-primary)] outline-none focus:border-[var(--accent)]"
      />
      <button
        type="button"
