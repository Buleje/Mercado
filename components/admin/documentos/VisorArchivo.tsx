      ...
      <div className="space-y-3">
        ...
        {docId && (
          <button
            ...
            className="mx-auto block rounded-xl border-2 border-[var(--rule-base)] px-4 min-h-10 text-sm font-bold text-[var(--text-secondary)] hover:border-primary hover:text-primary"
          >
            Verlo como imágenes
          </button>
        )}
