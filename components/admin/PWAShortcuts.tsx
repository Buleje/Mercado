  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        {isInstalled ? (
          <span className="flex items-center gap-1.5 text-xs font-medium text-[var(--data-success-500)] dark:text-[var(--data-success-700)] dark:text-[var(--data-success-500)] bg-[var(--data-success-500)]/12 dark:bg-primary/15 px-2.5 py-1 rounded-full">
      ...
      {activeTab === "install" && (
        <div className="space-y-6">
          {isInstalled ? (
            <div className="rounded-xl border border-[var(--data-success-500)]/30 dark:border-[var(--data-success-500)]/30 bg-primary/10 dark:bg-primary/15 p-4 flex items-start gap-3">
