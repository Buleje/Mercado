        ...
        <Seccion numero={1} title="Los pedazos que salen">
          ...
          <div className="sm:col-span-12">
            <button
              ...
              className="inline-flex h-10 items-center gap-1.5 rounded-xl border-2 border-[var(--rule-base)] px-3 text-sm font-semibold text-[var(--text-secondary)] transition-colors hover:border-primary hover:text-[var(--text-primary)]"
            >
