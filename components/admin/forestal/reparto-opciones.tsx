      ...
      <div>
        ...
        <div className="flex flex-wrap gap-2">
          <input
            ...
            className="h-9 flex-1 min-w-[140px] rounded-xl border border-[var(--rule-base)] bg-[var(--surface-raised)] px-2 text-sm text-[var(--text-primary)] outline-none focus:border-[var(--accent)]"
          />
          <input
            value={firmaCargo}
            ...
            className="h-9 w-40 rounded-xl border border-[var(--rule-base)] bg-[var(--surface-raised)] px-2 text-sm text-[var(--text-primary)] outline-none focus:border-[var(--accent)]"
          />
        </div>
      </div>
      {especies.length > 0 && (
