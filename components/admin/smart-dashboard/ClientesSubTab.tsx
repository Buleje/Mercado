        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          ...
          {growingCategory?.top && (
            <AdminCard padding="sm">
              ...
              <p className="text-sm font-bold text-[var(--text-primary)] dark:text-zinc-100">{growingCategory.top.cat} crecio {Number(growingCategory.top.pct).toFixed(0)}% esta semana</p>
          ...
          {topClientMonth && (
            <AdminCard padding="sm">
              ...
              <span className="inline-block text-[length:var(--ts-2xs)] font-bold bg-primary/10 dark:bg-[var(--data-success-500)]/12 text-[var(--data-success-700)] dark:text-[var(--data-success-500)] dark:text-[var(--data-success-500)] px-1.5 py-0.5 rounded-full mt-1.5 capitalize">
