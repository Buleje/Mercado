...
interface POSMetricsStripProps {
  /** Incrementar este valor tras una venta exitosa para refrescar las métricas */
  refreshKey?: number;
}

export default function POSMetricsStrip({ refreshKey }: POSMetricsStripProps = {}) {
  ...
  // Hallazgo #3 — refrescar métricas cuando refreshKey cambia (post-venta exitosa)
  useEffect(() => {
