          ...
          <div className="space-y-1">
            ...
            {loyaltyPoints >= 100 && !showRedeemSlider && (
              <button
                ...
                className="w-full text-[10px] font-bold text-[#0f766e] hover:underline py-0.5 flex items-center justify-center gap-1"
              >
          ...
          <div className="bg-gray-50 dark:bg-surface rounded-lg px-2 py-1.5">
            ...
            {onRepeatOrder && lastPurchase.items.some(i => i.active) && (
              <button
                ...
                className="mt-1 flex items-center gap-1 text-[10px] font-bold text-[#0f766e] hover:underline"
              >
