  ...
  const content = (
    <>
      ...
      <div className="flex items-center gap-2 px-3 py-3.5 border-b border-[var(--rule-base)] dark:border-card-border bg-white/50 dark:bg-card/80">
        ...
        <h2 className="text-[length:var(--ts-sm)] font-bold text-gray-700 dark:text-foreground truncate flex-1">
          {categoryLabel}
        </h2>
        {/* Mobile close */}
        {onMobileClose && (
          ...
          return (
            ...
            >
              ...
              {t.badge != null && t.badge > 0 && !alertCount && (
                <span className="text-[length:var(--ts-2xs)] text-gray-400 dark:text-muted font-medium">
                  {t.badge}
                </span>
              )}
            </button>
