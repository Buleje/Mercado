  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-2xl font-extrabold text-gray-900 dark:text-foreground">Recordatorios Inteligentes</h2>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        ...
        <div className="bg-red-50 dark:bg-red-950/20 rounded-2xl border border-red-200 dark:border-red-800 p-4 shadow-sm">
          ...
          <p className="text-2xl font-extrabold text-red-700 dark:text-red-400 mt-1">{stats.highPriority}</p>
        </div>
        <div className="bg-emerald-50 dark:bg-emerald-950/20 rounded-2xl border border-emerald-200 dark:border-emerald-800 p-4 shadow-sm">
          ...
          <p className="text-2xl font-extrabold text-emerald-700 dark:text-emerald-400 mt-1">{stats.completed}</p>
        </div>
        <div className="bg-white dark:bg-card rounded-2xl border border-gray-200 dark:border-card-border p-4 shadow-sm">
          <p className="text-xs text-gray-500 dark:text-muted font-semibold">Auto-generados</p>
          <p className="text-2xl font-extrabold text-blue-600 mt-1">{stats.autoGenerated}</p>
        </div>
      </div>
      ...
      <div className="space-y-3">
        {filtered.map(r => {
          ...
          return (
            <div key={r.id} className={cn("bg-white dark:bg-card rounded-2xl border border-gray-200 dark:border-card-border p-4 shadow-sm flex items-start gap-4 transition-all", isCompleted && "opacity-60")}>
          ...
          <div className="bg-white dark:bg-card rounded-2xl shadow-xl w-full max-w-md" onClick={e => e.stopPropagation()}>
            ...
            <div className="px-6 py-5 space-y-4">
              <div>
                ...
                <input type="text" value={newTitle} onChange={e => setNewTitle(e.target.value)} placeholder="¿Qué necesitas recordar?" className="w-full px-4 py-2.5 rounded-xl border-2 border-gray-200 dark:border-card-border bg-white dark:bg-surface text-gray-900 dark:text-foreground text-sm outline-none focus:border-primary" autoFocus />
              </div>
              <div>
                <label className="block text-sm font-semibold text-gray-700 dark:text-foreground mb-1">Descripción</label>
                <textarea value={newDesc} onChange={e => setNewDesc(e.target.value)} placeholder="Detalles opcionales..." rows={2} className="w-full px-4 py-2.5 rounded-xl border-2 border-gray-200 dark:border-card-border bg-white dark:bg-surface text-gray-900 dark:text-foreground text-sm outline-none focus:border-primary resize-none" />
              </div>
