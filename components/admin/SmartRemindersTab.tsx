        ...
        {filtered.map(r => {
          ...
          return (
            <div key={r.id} className={cn("bg-[var(--surface-raised)] rounded-xl border border-[var(--rule-base)] dark:border-[var(--rule-base)] p-4  flex items-start gap-2 sm:gap-4 transition-all", isCompleted && "opacity-60")}>
              <button onClick={() => handleComplete(r.id)} className={cn("mt-0.5 w-6 h-6 rounded-full border-2 flex items-center justify-center shrink-0 transition-colors", isCompleted ? "bg-[var(--accent-soft)] border-[var(--data-success-500)]/30" : "border-[var(--rule-base)] dark:border-[var(--rule-base)] hover:border-primary")}>
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 flex-wrap mb-1">
                  ...
                  {r.autoGenerated && <span className="px-1.5 py-0.5 rounded bg-[var(--accent-soft)] dark:bg-[var(--accent-muted)] text-[var(--data-success-500)] dark:text-[var(--data-success-500)] text-[length:var(--ts-2xs)] font-bold">AUTO</span>}
                </div>
