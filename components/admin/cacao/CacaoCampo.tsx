    ...
    <div className="space-y-4">
      ...
      {vista === "mapa" ? (
        ...
        <div className="rounded-2xl border border-dashed border-[var(--rule-base)] bg-[var(--surface-raised)] p-12 text-center text-[var(--text-tertiary)]">
          ...
          <p className="text-base font-bold text-[var(--text-primary)]">Dibuja tu chacra</p>
          <p className="mx-auto mt-1 max-w-sm text-sm">Agrega cada sección de tu terreno (ej. una hectárea = un código). Después registras poda, fertilización, cosecha y las ves acá por color.</p>
