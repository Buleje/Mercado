...
const TREND_ICON: Record<Trend, { icon: typeof ArrowUp; color: string; label: string }> = {
  subiendo: { icon: ArrowUp,   color: "text-emerald-600", label: "Subiendo" },
  estable:  { icon: Minus,     color: "text-gray-400",    label: "Estable" },
  bajando:  { icon: ArrowDown, color: "text-red-500",     label: "Bajando" },
};
  ...
  return (
    <div className="space-y-3 sm:space-y-6">
      ...
      <div className="flex flex-col sm:flex-row gap-3 flex-wrap">
        ...
        <select value={filterUrgency} onChange={e => setFilterUrgency(e.target.value as Urgency | "todos")} className="text-sm border border-gray-200 dark:border-card-border rounded-lg px-3 py-2 bg-white dark:bg-surface text-gray-700 dark:text-foreground">
