      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className={cn(
            ...
            saved ? "bg-emerald-500 text-white" : "bg-[#2d6a4f] hover:bg-[#235c42] text-white",
        ...
        {slots.map((slot) => (
          <div
            ...
            className={cn(
              ...
              slot.active
                ? "border-[#2d6a4f]/30 bg-[#2d6a4f]/5 dark:bg-[#2d6a4f]/10 dark:border-[#2d6a4f]/40"
          ...
          >
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                <Clock
                  size={15}
                  className={cn(slot.active ? "text-[#2d6a4f]" : "text-gray-400")}
                />
                <span
                  className={cn(
                    "text-sm font-medium",
              ...
              <button
                ...
                className={cn(
                  ...
                  slot.active ? "bg-[#2d6a4f]" : "bg-gray-300 dark:bg-gray-600"
                )}
                role="switch"
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-1.5">
                ...
                <input
                  ...
                  className="w-10 h-6 text-center text-sm font-semibold rounded-md border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-white disabled:opacity-40 focus:outline-none focus:ring-1 focus:ring-[#2d6a4f]"
                />
                <button
                  onClick={() => setMaxOrders(slot.id, 1)}
      ...
      {slots.map((slot) => (
        <button
          ...
          className={cn(
            ...
            value === slot.id
              ? "border-[#2d6a4f] bg-[#2d6a4f]/10 dark:bg-[#2d6a4f]/20 text-[#2d6a4f] dark:text-emerald-400"
              : "border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-700 dark:text-gray-300 hover:border-[#2d6a4f]/50 hover:bg-[#2d6a4f]/5"
          )}
        >
