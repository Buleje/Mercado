    ...
    <>
      ...
      {focusMode && !presentationMode && (
        <button
          ...
          className="hidden sm:flex fixed bottom-6 left-4 z-50 h-10 w-10 rounded-full bg-primary text-white items-center justify-center hover:bg-primary/90 transition-all"
      ...
      {presentationMode && (
        <button
          ...
          className="fixed top-4 right-4 z-50 flex items-center gap-2 px-4 py-2 rounded-xl bg-black/30 backdrop-blur-md text-white/80 text-sm font-semibold hover:bg-black/50 hover:text-white transition-all"
