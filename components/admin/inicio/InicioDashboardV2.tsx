...
export default function InicioDashboardV2(_props: Props) {
  ...
  return (
    <div className="space-y-4">
      ...
      {criticalStock > 0 && (
        <div className="rounded-xl border border-amber-200 dark:border-amber-800/40 bg-amber-50 dark:bg-amber-950/20 px-5 py-3 flex items-center gap-3 flex-wrap">
          <span className="text-[length:var(--ts-2xs)] font-bold uppercase tracking-[var(--ls-wider)] text-amber-800 dark:text-amber-400">
            Atención
          </span>
          <span className="text-sm text-amber-900 dark:text-amber-300 font-semibold">
          ...
          <a
            ...
            className="ml-auto text-xs font-bold text-amber-800 dark:text-amber-400 underline underline-offset-2 hover:opacity-80"
          >
            Revisar inventario →
          </a>
        </div>
