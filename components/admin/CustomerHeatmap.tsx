...
export default function CustomerHeatmap() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Insight banner */}
      {!loading && topZone && (
        <div className="flex items-center gap-3 rounded-xl bg-[#2d6a4f]/10 px-4 py-3 dark:bg-[#2d6a4f]/20">
          <TrendingUp className="h-5 w-5 shrink-0 text-[#2d6a4f]" />
      ...
      <div className="grid grid-cols-3 gap-3">
        <div className="rounded-xl border border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-gray-900">
          <p className="text-2xl font-bold text-[#2d6a4f]">{total}</p>
                    ...
                    <div className="mb-1 flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <button
                          ...
                          className="text-xs text-[#2d6a4f] underline-offset-2 hover:underline"
                        >
