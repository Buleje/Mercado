                  ...
                  <div key={p.id} className="flex items-center justify-between py-2 px-3 bg-amber-50 dark:bg-amber-950/30 rounded-lg">
                    ...
                    <div className="flex flex-wrap items-center gap-2 shrink-0">
                      ...
                      {p.costPrice != null && p.price > 0 && (
                        <span className="text-[length:var(--ts-2xs)] font-bold px-1.5 py-0.5 rounded bg-emerald-50 text-emerald-700 dark:bg-emerald-950/30 dark:text-emerald-400">
                          {Math.round((p.price - p.costPrice) / p.price * 100)}% mg
                        </span>
                      )}
                      {/* J2 — Suggested price (30% margin target) */}
                      {p.costPrice != null && p.costPrice > 0 && (
                        <span className="text-[length:var(--ts-2xs)] font-mono text-emerald-500" title="Precio sugerido (30% margen)">
                      ...
                      <a
                        ...
                        className="text-[length:var(--ts-2xs)] font-bold text-emerald-600 bg-emerald-50 hover:bg-emerald-100 dark:bg-emerald-950/30 dark:hover:bg-emerald-900/50 px-1.5 py-0.5 rounded transition-colors"
                        ...
                        <div key={productId} className="border border-[var(--rule-base)] dark:border-card-border rounded-lg overflow-hidden">
                          ...
                          >
                            <div className="flex flex-wrap items-center gap-3 flex-1 min-w-0">
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                <div className="text-[length:var(--ts-2xs)] text-gray-500 dark:text-muted">{recommendations.length} productos relacionados</div>
                              </div>
                            </div>
                          ...
                          {isExpanded && (
                            <div className="border-t border-[var(--rule-base)] dark:border-card-border bg-gray-50 dark:bg-surface p-3 space-y-2">
                              <div className="text-[length:var(--ts-2xs)] font-semibold text-gray-600 dark:text-gray-400 mb-2">Frecuentemente comprado junto con:</div>
              ...
              <div className="space-y-6">
                        ...
                        <div key={p.id} className="flex items-center justify-between py-2 px-3 bg-red-50 dark:bg-red-950/30 rounded-lg">
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex flex-wrap items-center gap-2 mt-0.5">
                              <span className="text-[length:var(--ts-2xs)] text-gray-500">
                          ...
                          <div className="flex flex-wrap items-center gap-2 shrink-0">
                            <div className="text-right">
                              ...
                              <div className="text-[length:var(--ts-2xs)] text-gray-500">Pedir: {p.suggestedOrderQty}</div>
                            </div>
                            <a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="text-[length:var(--ts-2xs)] font-bold text-white bg-red-500 hover:bg-red-600 px-2 py-1 rounded transition-colors"
                        ...
                        <div key={p.id} className="flex items-center justify-between py-2 px-3 bg-amber-50 dark:bg-amber-950/30 rounded-lg">
                          ...
                          <div className="flex flex-wrap items-center gap-2 shrink-0">
                            ...
                            <a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="text-[length:var(--ts-2xs)] font-bold text-amber-700 bg-amber-100 hover:bg-amber-200 dark:bg-amber-900/50 dark:hover:bg-amber-800/50 px-2 py-1 rounded transition-colors"
                ...
                {(st.criticalStock.length + st.needsReorderSoon.length) > 0 && (
                  <div className="border-t border-[var(--rule-soft)] dark:border-card-border pt-3">
                    ...
                    <p className="text-[length:var(--ts-2xs)] text-gray-400 text-center mt-1.5">
