            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2">
                <div className="bg-emerald-50 dark:bg-emerald-950/30 rounded-lg p-3">
                  ...
                  <div className="text-[length:var(--ts-2xs)] text-emerald-600/70 dark:text-emerald-400/70">~80% ventas</div>
                </div>
                <div className="bg-emerald-50 dark:bg-emerald-950/30 rounded-lg p-3">
                  ...
                  <div className="text-[length:var(--ts-2xs)] text-emerald-600/70 dark:text-emerald-400/70">~15% ventas</div>
                </div>
                <div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-3">
                  ...
                  <div className="text-[length:var(--ts-2xs)] text-gray-600/70 dark:text-gray-400/70">~5% ventas</div>
                </div>
              </div>
              ...
              <div className="bg-emerald-50 dark:bg-emerald-950/30 rounded-lg p-3 text-xs">
                ...
                <ul className="space-y-0.5 text-emerald-600 dark:text-emerald-300 text-[length:var(--ts-2xs)]">
                  ...
                  <div key={i} className="flex items-center justify-between py-2 px-3 rounded-lg bg-gray-50 dark:bg-accent/40 border border-[var(--rule-soft)] dark:border-card-border">
                    <div className="flex flex-wrap items-center gap-2 flex-1 min-w-0">
                      <span className={cn("w-5 h-5 rounded-full flex items-center justify-center text-[length:var(--ts-2xs)] font-bold shrink-0",
                        i < 3 ? "bg-[var(--surface-sunken)] text-[var(--text-secondary)] dark:text-[var(--text-primary)]" : "bg-gray-100 dark:bg-accent text-gray-400"
                      )}>{i+1}</span>
                      <div className="flex items-center gap-1.5 min-w-0">
                        <span className="text-xs text-gray-700 dark:text-gray-300 truncate">{pair.a}</span>
                        <span className="text-[length:var(--ts-2xs)] text-gray-400 shrink-0">+</span>
