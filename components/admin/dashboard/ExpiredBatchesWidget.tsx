          ...
          {!loading && batches.length > 0 && (
            <div className="px-4 py-2.5 border-t border-gray-50 dark:border-card-border bg-gray-50/50 dark:bg-surface/30 flex items-center justify-between gap-2">
              <a
                ...
                className="text-xs font-semibold text-[#0f766e] dark:text-emerald-400 hover:underline"
              >
                Ver todos los lotes
              </a>
              <button
            ...
            >
              ...
              <div className="px-5 py-3">
                ...
                <select
                  ...
                  disabled={modal.submitting}
                  className="w-full rounded-xl border border-gray-200 dark:border-card-border bg-white dark:bg-surface text-xs text-gray-800 dark:text-foreground px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#0f766e]/30 disabled:opacity-50"
                >
