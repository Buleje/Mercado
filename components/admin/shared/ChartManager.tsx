    ...
    <>
      ...
      <div className={cn("space-y-6", showEmptyState && "hidden", className)}>
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 min-h-11 px-4 rounded-xl border border-dashed border-[var(--rule-base)] text-[var(--text-tertiary)] hover:border-gray-300 dark:hover:border-gray-600 hover:text-[var(--text-secondary)] dark:hover:text-[var(--text-tertiary)] transition-colors text-sm font-medium"
        >
