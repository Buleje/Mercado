      ...
      {search && (
        <div className="relative flex-1 min-w-[200px] max-w-sm">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 h-11 text-sm rounded-xl border border-[var(--rule-base)] bg-[var(--surface-raised)] focus:border-[var(--data-success-500)]/30 focus:ring-1 focus:ring-[var(--data-success-500)]/40 outline-none transition-all"
          />
        </div>
      )}
