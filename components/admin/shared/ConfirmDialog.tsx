            ...
            <div className="flex items-center justify-end gap-2 px-5 py-3 border-t border-[var(--rule-soft)] bg-[var(--surface-sunken)]">
              <AlertDialog.Cancel asChild>
                <button
                  ...
                  className="px-4 min-h-10 rounded-xl text-sm font-semibold text-[var(--text-secondary)] hover:bg-[var(--surface-raised)] transition-colors"
                >
              ...
              <AlertDialog.Action asChild>
                <button
                  ...
                  className={cn(
                    "px-4 min-h-10 rounded-xl text-sm font-semibold text-white transition-opacity",
                    styles.btn,
                  )}
                >
