  ...
  return (
    <div className="flex flex-col h-full bg-zinc-800 text-zinc-200">
      ...
      <div className="px-5 pt-5 pb-3 border-b border-zinc-700">
        <h2 className="text-[length:var(--ts-sm)] font-bold text-white leading-tight">
      ...
      <div className="px-5 py-3 border-t border-zinc-700">
        ...
        <select
          ...
          className="w-full bg-zinc-700 text-zinc-200 text-[length:var(--ts-sm)] rounded-lg px-3 py-2 border border-zinc-600 focus:outline-none focus:ring-2 focus:ring-emerald-500/50"
        >
      ...
      <div className="px-5 py-4 space-y-2 border-t border-zinc-700">
        <button
          onClick={handleSave}
          className="bg-emerald-500 hover:bg-emerald-600 text-white rounded-lg py-3 w-full font-semibold text-[length:var(--ts-sm)] transition-colors"
        >
          Guardar
        </button>
        <button
