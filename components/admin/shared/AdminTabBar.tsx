      ...
      <div className={cn("flex flex-col gap-3 lg:flex-row lg:items-stretch lg:gap-0", className)}>
        ...
        <nav className={cn(
            ...
            {orderedTabs.map((tab) => {
              ...
              return (
                ...
                >
                  ...
                  {tab.badge != null && (
                    <span className="ml-auto flex h-4 min-w-[16px] shrink-0 items-center justify-center rounded-full bg-red-500 px-1 text-[length:var(--ts-2xs)] font-bold text-white">
                      {tab.badge}
                    </span>
                  )}
                </button>
          ...
          {isReordered && (
            <button
              onClick={resetOrder}
              className="mt-1.5 w-full border-t border-[var(--rule-soft)] px-3 pt-1.5 text-left text-[length:var(--ts-2xs)] text-gray-400 transition-colors hover:text-primary dark:border-white/10"
            >
              Restablecer orden
            </button>
          )}
    ...
    <div className={cn("relative", className)}>
      ...
      >
        {orderedTabs.map((tab) => {
          ...
          return (
            ...
            >
              ...
              {tab.badge != null && (
                <span className="flex h-4 min-w-[16px] items-center justify-center rounded-full bg-red-500 px-1 text-[length:var(--ts-2xs)] font-bold text-white">
                  {tab.badge}
                </span>
              )}
            </button>
        ...
        {isReordered && (
          <button
            onClick={resetOrder}
            className="ml-1 shrink-0 whitespace-nowrap px-2 py-1.5 text-[length:var(--ts-2xs)] text-gray-400 transition-colors hover:text-primary"
