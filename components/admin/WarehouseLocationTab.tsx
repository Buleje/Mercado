  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
        <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-card-border dark:bg-card"><p className="text-xs font-semibold uppercase text-gray-500 dark:text-muted">Ubicaciones Ocupadas</p><p className="mt-1 text-2xl font-extrabold text-gray-900 dark:text-foreground">{occupied}/{totalSlots}</p></div>
        <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-card-border dark:bg-card"><p className="text-xs font-semibold uppercase text-gray-500 dark:text-muted">Espacios Libres</p><p className="mt-1 text-2xl font-extrabold text-emerald-600 dark:text-emerald-400">{empty}</p></div>
        <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-card-border dark:bg-card"><p className="text-xs font-semibold uppercase text-gray-500 dark:text-muted">Ocupacion Promedio</p><p className="mt-1 text-2xl font-extrabold text-blue-600 dark:text-blue-400">{avgOccupancy.toFixed(0)}%</p></div>
        <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-card-border dark:bg-card"><p className="text-xs font-semibold uppercase text-gray-500 dark:text-muted">Casi Llenos (&gt;90%)</p><p className="mt-1 text-2xl font-extrabold text-amber-600 dark:text-amber-400">{critical}</p></div>
      </div>

      <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-card-border dark:bg-card">
        <div className="mb-4 flex items-center gap-2 text-sm font-extrabold text-gray-900 dark:text-foreground"><Plus className="h-4 w-4 text-primary" /> Nueva ubicacion</div>
        ...
        <button onClick={addLocation} disabled={saving} className="mt-4 rounded-xl bg-primary px-4 py-2.5 text-sm font-bold text-white transition-colors hover:bg-primary/90 disabled:opacity-50">{saving ? "Guardando..." : "Crear ubicacion"}</button>
      </div>

      <div className="rounded-2xl border border-gray-200 bg-white p-6 dark:border-card-border dark:bg-card">
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <button onClick={() => setShowEmpty((prev) => !prev)} className={cn("rounded-xl px-4 py-2.5 text-sm font-bold transition-colors", showEmpty ? "bg-primary text-white" : "border border-gray-200 bg-white text-gray-600 dark:border-card-border dark:bg-card dark:text-muted")}>{showEmpty ? "Mostrando vacios" : "Ocultar vacios"}</button>
      </div>
