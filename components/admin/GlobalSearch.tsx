...
const MODULE_INDEX: ModuleEntry[] = [
  {
    ...
    subtabs: [
      { id: "panel-principal", label: "Dashboard", keywords: ["dashboard", "inicio", "ventas"] },
  ...
  },
  {
    ...
    subtabs: [
      { id: "pos-caja", label: "Punto de Venta (POS)", keywords: ["pos", "venta", "cobrar"] },
  ...
  },
  {
    ...
    subtabs: [
      { id: "inventario-almacenes", label: "Stock", keywords: ["stock", "existencias"] },
      { id: "inventario-almacenes", label: "Kardex", keywords: ["kardex", "movimientos"] },
      { id: "inventario-almacenes", label: "Lotes", keywords: ["lotes", "batch", "vencimiento", "fefo"] },
      { id: "inventario-almacenes", label: "Mermas", keywords: ["mermas", "pérdidas", "desperdicios"] },
      ...
      { id: "inventario-almacenes", label: "Predicción IA", keywords: ["predicción", "demanda", "forecast"] },
      { id: "inventario-almacenes", label: "Conteo Físico", keywords: ["conteo", "físico", "inventario físico"] },
    ],
  },
  {
    tab: "reposicion",
  ...
  },
  {
    ...
    subtabs: [
      ...
      { id: "compras", label: "Cotizaciones (RFQ)", keywords: ["cotizaciones", "rfq"] },
      { id: "compras", label: "Aprobación", keywords: ["aprobación", "aprobar"] },
  ...
  },
  {
    ...
    subtabs: [
      { id: "logistica", label: "Calendario Entregas", keywords: ["calendario", "entregas"] },
      { id: "logistica", label: "Rutas Delivery", keywords: ["rutas", "delivery"] },
      { id: "logistica", label: "Seguimiento Envíos", keywords: ["seguimiento", "tracking"] },
  ...
  },
  {
    ...
    subtabs: [
      { id: "crm-clientes", label: "CRM", keywords: ["crm"] },
  ...
  },
  {
    ...
    label: "Fidelización",
    icon: Heart,
    keywords: ["fidelización", "puntos", "loyalty", "wish list", "recompensas"],
  },
  {
    tab: "encuestas-soporte",
    label: "Encuestas & Soporte",
    icon: Star,
    keywords: ["encuestas", "soporte", "nps", "tickets", "satisfacción", "reseñas"],
  },
  {
    tab: "analytics-bi",
    label: "Analytics & BI",
    icon: BarChart3,
    keywords: ["analytics", "bi", "análisis", "mapa calor", "abc", "pareto", "bcg", "kpi", "cesta"],
  },
  {
    tab: "proyecciones",
    label: "Proyecciones",
  ...
  },
  {
    ...
    label: "Finanzas",
    icon: DollarSign,
    keywords: ["finanzas", "p&g", "balance", "flujo caja", "presupuestos", "rentabilidad", "márgenes"],
  },
  {
    tab: "finanzas",
    label: "Tesorería",
    icon: Calculator,
    keywords: ["tesorería", "liquidez", "cheques", "conciliación", "cuentas cobrar"],
  },
  {
    tab: "finanzas",
    label: "Facturación",
    icon: FileText,
    keywords: ["facturación", "e-factura", "impuestos", "cuentas pagar"],
  },
  {
    tab: "finanzas",
  ...
  },
  {
    ...
    label: "RRHH",
    icon: UserCog,
    keywords: ["rrhh", "recursos humanos", "nómina", "sucursales", "personal", "empleados"],
  },
  {
  ...
  {
    tab: "sistema",
    label: "Sistema & Backups",
    icon: Settings,
    keywords: ["sistema", "backups", "webhooks", "salud sistema", "restaurar"],
  },
  {
    tab: "agentes",
    label: "Agentes IA",
...
const QUICK_ACCESS = [
  ...
  { label: "Inventario",     tab: "inventario-almacenes", icon: Boxes,          color: "text-blue-500 bg-blue-50 dark:bg-blue-900/20" },
  { label: "Clientes",       tab: "crm-clientes",         icon: Users,          color: "text-violet-500 bg-violet-50 dark:bg-violet-900/20" },
  { label: "Punto de Venta", tab: "pos-caja",             icon: Monitor,        color: "text-emerald-500 bg-emerald-50 dark:bg-emerald-900/20" },
