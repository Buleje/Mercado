...
import { Tag, X, ArrowRight } from "@buleje/design-system/icons";
...
export default function StickyCouponBanner({
  ...
  function handleApply() {
    // El código solo se copia si la API lo expone. Desde el hardening anti-scraping
    // (PENTEST Sprint C #9) `/api/coupons/active` devuelve code:null → en ese caso
    // el banner es solo recordatorio y la acción lleva a la tienda (ver abajo).
  ...
  // URL de la tienda para el CTA cuando no hay código que copiar.
  const shopHref = `/t/${tenantSlug}/tienda`;
