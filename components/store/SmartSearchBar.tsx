    ...
    <div ref={containerRef} className={cn("relative", className)}>
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-9 pr-16 py-2.5 rounded-xl border border-[var(--rule-base)] dark:border-[var(--rule-base)] bg-[var(--surface-raised)] text-sm focus:outline-none focus:ring-2 focus:ring-primary/30 dark:text-[var(--text-primary)]"
        />
      ...
      {/* Results dropdown */}
      {open && (query.length >= 2) && (
        <div className="absolute top-full left-0 right-0 mt-1 bg-[var(--surface-raised)] border border-[var(--rule-base)] dark:border-[var(--rule-base)] rounded-xl shadow-xl z-50 max-h-80 overflow-y-auto">
          {loading ? (
            ...
            results.map((product, i) => (
              <button
                ...
                className={cn(
                  ...
                  i < results.length - 1 && "border-b border-[var(--rule-soft)] dark:border-[var(--rule-base)]"
                )}
              >
                {product.image ? (
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-bold text-gray-900 dark:text-[var(--text-primary)] truncate">{product.name}</p>
                  {product.category && (
