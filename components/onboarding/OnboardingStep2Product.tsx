        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-3 rounded-xl border-2 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white outline-none focus:border-[#0f766e] transition-colors"
            >
              {CATEGORIAS.map(cat => (
