...
function ProductCard({ product, onQuickView }: { product: LiveProduct; onQuickView?: (p: LiveProduct) => void }) {
  ...
  return (
    <div className={cn(
      "group relative bg-white dark:bg-card rounded-2xl shadow-sm overflow-hidden border border-gray-100 dark:border-card-border hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col",
      ...
      <div className="p-3 sm:p-4 flex flex-col gap-2 flex-1">
        ...
        <div className="flex items-end justify-between gap-2">
          <div>
            ...
            <span className="block text-xs text-muted">por {product.unit}</span>
          </div>
