    ...
    <section className="border-b border-[var(--rule-base)] bg-[var(--surface-raised)] py-16 sm:py-24">
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        <header className="mb-10 max-w-2xl">
          <p className="inline-flex items-center gap-1.5 text-[10px] font-bold uppercase tracking-[0.22em] text-[var(--text-tertiary)]">
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-5">
          ...
          <div className="space-y-5 rounded-2xl border border-[var(--rule-base)] bg-[var(--surface-canvas)] p-6 lg:col-span-3">
            ...
            <div>
              ...
              />
              <div className="mt-1 flex justify-between text-[10px] font-medium uppercase tracking-wider text-[var(--text-tertiary)]">
                <span>10</span>
                <span>600</span>
              </div>
            </div>
          ...
          <div className="space-y-4 rounded-2xl border border-[var(--rule-base)] bg-[var(--text-primary)] p-6 text-[var(--surface-canvas)] lg:col-span-2">
            <p className="flex items-center gap-1.5 text-[10px] font-bold uppercase tracking-[0.22em] opacity-70">
