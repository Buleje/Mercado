  ...
  return (
    <div className="border-b border-gray-200 dark:border-[rgba(45,106,79,0.18)] last:border-b-0">
      <button
        ...
        className="w-full flex items-center justify-between gap-4 py-5 text-left focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#0f766e] min-h-[44px]"
      >
