        ...
        {[
          ...
          >
            ...
            <span
              ...
              style={{ color: kpi.up ? "#0f766e" : "#ef4444" }}
            >
              {kpi.up ? "▲ 12%" : "▼ 4%"}
            </span>
          </div>
            ...
            return (
              <div key={i} className="flex-1 flex flex-col items-center gap-1">
                ...
                <span
                  ...
                  style={{
                    color: isToday ? "#0f766e" : "rgba(156,163,175,0.7)",
                  }}
                >
                  {BAR_DAYS[i]}
                </span>
    ...
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 h-full">
      ...
      <div className="sm:col-span-2 grid grid-cols-3 gap-2">
        {POS_PRODUCTS.map((p) => (
          <div
            key={p.name}
            className="rounded-xl border border-gray-100 dark:border-[rgba(15,118,110,0.18)] bg-white dark:bg-[#152019] p-2 flex flex-col items-center gap-1 hover:border-[#0f766e]/40 transition-colors duration-150"
          >
            ...
            <div
              ...
              aria-hidden="true"
            >
              <ShoppingCart className="w-3.5 h-3.5" style={{ color: "#0f766e" }} />
            </div>
          ...
          {rows.map((r) => (
            ...
            >
              ...
              <td
                ...
                style={{ color: r.ok ? "#0f766e" : "#ef4444" }}
              >
                {r.stock}
              </td>
...
function MockAnalytics() {
  const insights = [
    ...
    { label: "Aceite 1L: margen subió 8%", color: "#0f766e" },
    { label: "Sábados venden 2x más que lunes", color: "#0f766e" },
  ];
  return (
    <div className="flex flex-col sm:flex-row gap-4 items-start">
      ...
      <div className="flex flex-col items-center gap-2 shrink-0">
        ...
        >
          <span className="text-2xl font-black" style={{ color: "#0f766e" }}>
            87
          </span>
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
          ...
          {tabs.map((tab) => {
            ...
            return (
              <button
                ...
                className="shrink-0 flex items-center gap-1.5 px-4 py-2 rounded-full text-sm font-semibold transition-all duration-200 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#0f766e] whitespace-nowrap"
                style={
                  isActive
                    ? {
                        background:
        ...
        >
          ...
          <div className="flex items-center gap-2 px-4 py-3 bg-gray-100 dark:bg-[#152019] border-b border-gray-200 dark:border-[rgba(15,118,110,0.18)]">
            ...
            <div className="w-3 h-3 rounded-full bg-[#0f766e]" aria-hidden="true" />
            {/* URL bar */}
