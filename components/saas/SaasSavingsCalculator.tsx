...
export default function SaasSavingsCalculator() {
  ...
  const results = [
    { label: "Horas ahorradas/mes", value: `${hoursSaved}h`, icon: <Clock className="h-5 w-5" />, color: "text-[var(--data-success-600)] bg-emerald-50 dark:bg-emerald-950/30" },
    { label: "Ahorro en merma/mes", value: `S/ ${wasteSaved.toLocaleString()}`, icon: <DollarSign className="h-5 w-5" />, color: "text-[var(--data-success-600)] bg-emerald-50 dark:bg-emerald-950/30" },
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 sm:p-8 border border-gray-200 dark:border-gray-700 space-y-8">
            ...
            <div className="space-y-3">
              <div className="flex justify-between">
                ...
                <span className="text-sm font-extrabold text-[var(--accent-dark)] dark:text-[var(--accent)]">{salesPerDay}</span>
              </div>
              <input
                type="range"
                min={5}
            ...
            <div className="space-y-3">
              <div className="flex justify-between">
                ...
                <span className="text-sm font-extrabold text-[var(--accent-dark)] dark:text-[var(--accent)]">{employees}</span>
              </div>
              <input
                type="range"
                min={1}
            ...
            <div className="space-y-3">
              <div className="flex justify-between">
                ...
                <span className="text-sm font-extrabold text-[var(--accent-dark)] dark:text-[var(--accent)]">{wastePercent}%</span>
              </div>
              <input
                type="range"
                min={1}
          ...
          <div className="space-y-4">
            ...
            {/* Total */}
            <div className="p-5 rounded-2xl bg-linear-to-r from-[var(--accent)] to-[var(--data-success-600)] text-white">
              ...
              <a
                href="/registro"
                className="inline-block mt-3 px-5 py-2 rounded-xl bg-white text-[var(--accent-dark)] dark:text-[var(--accent)] text-sm font-bold hover:bg-white/90 transition-colors"
              >
                Empezar gratis
              </a>
            </div>
