  ...
  return (
    ...
    >
      <div className="relative h-40 sm:h-auto sm:w-48 shrink-0 bg-[var(--surface-sunken)]">
        ...
        />
        <span className="absolute top-2 left-2 inline-flex items-center gap-1.5 rounded-full bg-[var(--data-error)] px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider text-white">
