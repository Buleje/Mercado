...
export default function PremiumStoreCard({
  ...
  return (
    <Link
      ...
      className="group relative flex flex-col gap-4 overflow-hidden rounded-3xl border-2 border-[var(--accent)]/40 bg-[var(--surface-raised)] p-4 sm:p-5 transition-all hover:border-[var(--accent)] hover:shadow-xl focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--accent)] sm:flex-row sm:items-stretch"
      style={{ background: "linear-gradient(120deg, var(--accent-soft) 0%, var(--surface-raised) 45%)" }}
    >
      {/* Badge Premium */}
      <span className="absolute right-3 top-3 z-10 inline-flex items-center gap-1 rounded-full bg-[var(--accent)] px-2.5 py-1 text-[10px] font-black uppercase tracking-wide text-white shadow-md">
      ...
      <div className="flex gap-3 sm:w-[300px] sm:shrink-0 sm:flex-col sm:gap-3 sm:border-r sm:border-[var(--rule-soft)] sm:pr-5">
        ...
        <div className="min-w-0">
          ...
          <span className="mt-3 hidden items-center gap-1.5 text-sm font-extrabold text-[var(--accent)] group-hover:gap-2.5 transition-all sm:inline-flex">
      ...
      <div className="min-w-0 flex-1">
        ...
        <span className="mt-3 inline-flex items-center gap-1.5 text-sm font-extrabold text-[var(--accent)] group-hover:gap-2.5 transition-all sm:hidden">
          Ver tienda <ArrowRight className="h-4 w-4" strokeWidth={2.5} aria-hidden />
        </span>
      </div>
    </Link>
