    ...
    <div className="mx-auto max-w-2xl space-y-8">
      ...
      <div className="space-y-5">
        <div>
          <label
            htmlFor="message"
            className="flex items-center justify-between text-sm font-semibold text-[var(--text-primary)] dark:text-white"
          >
            <span>Mensaje (opcional)</span>
            <span
              className={[
                "text-xs font-normal",
                remaining < 20 ? "text-[var(--data-warning-600)]" : "text-[var(--text-secondary)] dark:text-gray-400",
              ].join(" ")}
            >
          ...
          <textarea
            ...
            className="mt-2 block w-full resize-none rounded-xl border border-gray-200 bg-white px-4 py-3 text-sm text-[var(--text-primary)] outline-none placeholder:text-[var(--text-tertiary)] focus:border-gray-900 focus:ring-1 focus:ring-gray-900 dark:border-gray-700 dark:bg-gray-900 dark:text-white dark:placeholder:text-[var(--text-secondary)] dark:focus:border-white dark:focus:ring-white"
          />
          <div className="mt-3 flex flex-wrap gap-2">
            <span className="flex items-center gap-1 text-xs font-semibold text-[var(--text-secondary)] dark:text-gray-400">
            ...
            {SUGGESTIONS.map((s, idx) => (
              <button
                ...
                className="rounded-full border border-gray-200 bg-white px-2.5 py-1 text-[length:var(--ts-2xs)] text-[var(--text-primary)] transition-colors hover:border-gray-400 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 dark:hover:border-gray-500 dark:hover:bg-gray-800"
              >
                {s}
              </button>
            ))}
        ...
        <div>
          ...
          <p className="mt-0.5 text-xs text-[var(--text-secondary)] dark:text-gray-400">
          ...
          <input
            ...
            className="mt-2 block w-full rounded-xl border border-gray-200 bg-white px-4 py-3 text-sm text-[var(--text-primary)] outline-none placeholder:text-[var(--text-tertiary)] focus:border-gray-900 focus:ring-1 focus:ring-gray-900 dark:border-gray-700 dark:bg-gray-900 dark:text-white dark:placeholder:text-[var(--text-secondary)] dark:focus:border-white dark:focus:ring-white"
          />
        </div>
      </div>
