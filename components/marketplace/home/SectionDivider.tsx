  ...
  return (
    ...
    >
      <div className="relative flex items-center gap-4">
        <div className="flex-1 h-px bg-gradient-to-r from-transparent to-[var(--rule-soft)]" />
        ...
        <div className="flex-1 h-px bg-gradient-to-l from-transparent to-[var(--rule-soft)]" />
      </div>
    </div>
  );
}
