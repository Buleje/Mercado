    ...
    <div className="relative">
      <motion.button
        ...
        animate={
          pulse
            ? {
                // Burst al agregar: scale aggressive + wobble lateral
                scale: [1, 1.22, 0.94, 1.12, 1],
                rotate: [0, -10, 10, -5, 0],
              }
            : hasItems
              // Idle "breath" continuo cuando hay items — constante recordatorio
              // sutil de que hay items pendientes. ~3.6s loop, scale 1 ↔ 1.04.
              ? {
                  scale: [1, 1.045, 1],
                  rotate: [0, 0, 0],
                }
