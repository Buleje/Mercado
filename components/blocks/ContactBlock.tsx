              ...
              const content = (
                <>
                  <div className="flex items-center gap-3 mb-2">
                    <div className={`flex h-10 w-10 items-center justify-center rounded-lg bg-primary/10 text-[var(--accent-ink)] dark:text-[var(--accent)] ${item.href ? 'group-hover:bg-primary group-hover:text-white' : ''} transition-colors`}>
