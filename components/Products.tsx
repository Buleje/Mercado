    ...
    <section id="productos" className="py-24 bg-muted" ref={ref}>
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          {categoryTabs.map((cat) => (
            <a
              key={cat}
              href="#contacto"
              className="inline-flex items-center gap-1.5 rounded-full border border-primary/20 bg-white dark:bg-card px-5 py-2 text-sm font-medium text-foreground hover:bg-primary hover:text-white hover:border-primary transition-all duration-200 shadow-sm"
            >
        ...
        <m.p
          ...
          className="text-center text-sm text-foreground/50 mt-5"
        >
