...
const ACTIVITIES = [
  { Icon: ShoppingCart, color: "#2d6a4f", msg: "Ana M. de Yarinacocha acaba de pedir Arroz Costeño 5 kg" },
  { Icon: Star, color: "#f59e0b", msg: 'Rosa A. reseñó con ⭐⭐⭐⭐⭐: "¡Llegó rapidísimo!"' },
  { Icon: ShoppingCart, color: "#2d6a4f", msg: "Luis T. agregó Aceite Primor 1L al carrito" },
  { Icon: Truck, color: "#10b981", msg: "Pedido #1852 está en camino a Pucallpa centro" },
  { Icon: ShoppingCart, color: "#2d6a4f", msg: "Carmen V. realizó su pedido por WhatsApp" },
  { Icon: Package, color: "#10b981", msg: "14 pedidos entregados hoy en Pucallpa" },
  { Icon: ShoppingCart, color: "#2d6a4f", msg: "Pedro G. pidió 3 Gaseosas Inca Kola 1.5 L" },
  { Icon: Star, color: "#f59e0b", msg: "Marco R. reseñó con ⭐⭐⭐⭐⭐ su último pedido" },
  { Icon: ShoppingCart, color: "#2d6a4f", msg: "María P. acaba de comprar Pan de molde + Mantequilla" },
