    ...
    >
      <defs>
        ...
        <linearGradient id="bldg2" x1="0" y1="0" x2="0" y2="1">
          ...
          <stop offset="100%" stopColor="#009690" />
        </linearGradient>
        <filter id="glow">
      ...
      {/* Rooftop antenna */}
      <rect x="96" y="108" width="2" height="14" fill="#33C4B8" />
      <circle cx="97" cy="107" r="3" fill="#f59e0b" filter="url(#glow)" />
      {/* Sign Bodega */}
      <rect x="64" y="200" width="62" height="20" fill="#00B4A6" rx="4" />
      ...
      <g className="scooter-group">
        <g className="scooter-bob">
          {/* Box / package */}
          <rect x="14" y="287" width="18" height="14" fill="#00B4A6" rx="2" />
          <rect x="15" y="288" width="16" height="12" fill="none" stroke="#33C4B8" strokeWidth="0.8" rx="1.5" />
          <text x="23" y="297" textAnchor="middle" fill="white" fontSize="5" fontWeight="bold" fontFamily="sans-serif">📦</text>

          {/* Body */}
          <ellipse cx="20" cy="308" rx="18" ry="7" fill="#009690" />
          <rect x="8" y="302" width="24" height="10" fill="#00B4A6" rx="4" />

          {/* Seat + rider */}
          <rect x="18" y="298" width="12" height="5" fill="#33C4B8" rx="2" />
          {/* Helmet */}
          ...
          <circle cx="10" cy="313" r="2" fill="#00B4A6" />
          <circle cx="34" cy="313" r="7" fill="#1f2937" />
          <circle cx="34" cy="313" r="5" fill="#374151" />
          <circle cx="34" cy="313" r="2" fill="#00B4A6" />
      ...
      <rect x="0" y="270" width="50" height="90" fill="#0a0f0d" opacity="0.7" />
      <rect x="470" y="280" width="50" height="80" fill="#0a0f0d" opacity="0.7" />

      {/* Ambient glow on road */}
      <ellipse cx="260" cy="310" rx="180" ry="15" fill="rgba(45,106,79,0.08)" />
    </svg>
  );
}
