    ...
    >
      ...
      <g className="scooter-group">
        <g className="scooter-bob">
          {/* Box / package */}
          <rect x="14" y="287" width="18" height="14" fill="var(--accent)" rx="2" />
          <rect x="15" y="288" width="16" height="12" fill="none" stroke="color-mix(in oklab, var(--accent) 70%, white)" strokeWidth="0.8" rx="1.5" />
          <text x="23" y="297" textAnchor="middle" fill="white" fontSize="5" fontWeight="bold" fontFamily="sans-serif">📦</text>

          {/* Body */}
          <ellipse cx="20" cy="308" rx="18" ry="7" fill="var(--accent-dark)" />
          <rect x="8" y="302" width="24" height="10" fill="var(--accent)" rx="4" />
          ...
          <circle cx="10" cy="313" r="2" fill="var(--accent)" />
          <circle cx="34" cy="313" r="7" fill="#1f2937" />
          <circle cx="34" cy="313" r="5" fill="#374151" />
          <circle cx="34" cy="313" r="2" fill="var(--accent)" />
