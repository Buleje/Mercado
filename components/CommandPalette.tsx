...
export const ADMIN_QUICK_ACTIONS: AdminQuickAction[] = [
  { id: "a-crear-producto",  label: "Crear producto",       subtitle: "Agregar nuevo producto al inventario",      icon: <Package    className="w-4 h-4 text-[var(--data-success-500)]"    />, href: "/admin?tab=productos&new=1",                 roles: ["admin", "almacenero"] },
  { id: "a-nueva-venta",     label: "Nueva venta",          subtitle: "Registrar un pedido nuevo",                  icon: <Zap        className="w-4 h-4 text-[var(--data-success-500)]" />, href: "/admin?tab=pedidos",                         roles: ["admin", "cajero"] },
  { id: "a-registrar-gasto", label: "Registrar gasto",      subtitle: "Ir a Mi Plata para registrar un gasto",    icon: <DollarSign className="w-4 h-4 text-[var(--data-error-500)]"     />, href: "/admin?tab=plata",                           roles: ["admin"] },
  { id: "a-cobrar-fiado",    label: "Cobrar fiado",         subtitle: "Gestionar cuentas por cobrar",              icon: <Receipt    className="w-4 h-4 text-[var(--data-warning-500)]"   />, href: "/admin?tab=fiados",                          roles: ["admin", "cajero"] },
  ...
  { id: "a-nuevo-cliente",   label: "Nuevo cliente",        subtitle: "Registrar un nuevo cliente en el CRM",     icon: <UserPlus   className="w-4 h-4 text-[var(--data-success-500)]"     />, href: "/admin?tab=clientes&new=1",                  roles: ["admin", "cajero"] },
  ...
  return (
    ...
    >
      <div
        ...
        className="w-full max-w-2xl mx-4 bg-white dark:bg-gray-900 rounded-2xl shadow-[var(--shadow-xl)] border border-gray-200 dark:border-gray-700 overflow-hidden"
