          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <div className="flex items-center gap-2.5 mb-4">
              ...
              <div>
                ...
                <span className="text-[11px] text-white/40 font-medium">Pucallpa, Ucayali</span>
              </div>
            </div>
            {/* Stars */}
            <div className="flex items-center gap-1.5 mb-3">
              ...
              <span className="text-white/60 text-xs ml-1">4.8 / 5 · +800 clientes</span>
            </div>
            ...
            <div className="flex items-center gap-2 flex-wrap">
              <a
                ...
                className="inline-flex items-center gap-2 rounded-xl px-4 py-2.5 text-sm font-bold text-white transition-all hover:scale-[1.03] active:scale-[0.97]"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-1.5 h-10 px-3 rounded-xl bg-white/10 hover:bg-white/20 transition-colors text-white text-xs font-semibold"
                aria-label="Facebook"
              >
                f/ Facebook
              </a>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-5">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex flex-wrap items-center justify-center sm:justify-start gap-3">
              <div className="flex items-center gap-1.5 rounded-full px-3 py-1.5 text-xs text-white/60" style={{ background: "rgba(255,255,255,0.08)" }}>
