...
export default function ScrollToTop() {
  ...
  return (
    <button
      ...
      className="fixed bottom-28 left-4 z-35 flex items-center justify-center h-12 w-12 rounded-full bg-primary text-white shadow-lg hover:bg-primary-dark hover:scale-110 active:scale-95 transition-all duration-200 animate-[fadeUp_0.3s_ease-out] sm:bottom-6 sm:right-6 sm:left-auto"
    >
      {/* Progress ring */}
