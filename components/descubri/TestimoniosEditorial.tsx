        ...
        <ul className="grid grid-cols-1 gap-5 md:grid-cols-3">
          {TESTIMONIOS.map((t) => (
            ...
            >
              ...
              <span className="mt-auto inline-flex items-center gap-1.5 self-start rounded-full border border-[var(--rule-base)] bg-[var(--surface-canvas)] px-3 py-1 text-[length:var(--ts-2xs)] font-bold uppercase tracking-[var(--ls-wider)] text-[var(--text-tertiary)]">
                {t.feature}
              </span>
            </li>
          ))}
