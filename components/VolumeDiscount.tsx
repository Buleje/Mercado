...
export default function VolumeDiscount() {
  ...
  return (
    <>
      ...
      <div className="sm:hidden fixed bottom-4 left-4 z-30 animate-[fadeUp_0.4s_ease-out] max-w-[calc(100vw-7rem)]">
      ...
      {/* ── Desktop: full card ────────────────────────────────────────────── */}
      <div className="hidden sm:block fixed bottom-4 right-4 w-80 z-30 animate-[fadeUp_0.4s_ease-out]">
