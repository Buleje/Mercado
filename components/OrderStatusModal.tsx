...
const STATUS_STEPS = [
  { key: "pendiente",  label: "Recibido",   sublabel: "Pedido registrado",  icon: Receipt,       color: "#3b82f6", bg: "bg-blue-500",    ringColor: "ring-blue-300"    },
  ...
  { key: "en_camino",  label: "En camino",  sublabel: "Delivery salió",    icon: Truck,         color: "#f59e0b", bg: "bg-amber-500",   ringColor: "ring-amber-300"   },
    ...
    <AnimatePresence>
      ...
      >
        <m.div
          ...
          className="relative bg-white dark:bg-[#0f1117] rounded-t-3xl sm:rounded-3xl shadow-2xl w-full sm:max-w-lg max-h-[94vh] overflow-hidden flex flex-col"
        ...
        >
          ...
          <div
            ...
            style={{ background: "linear-gradient(135deg, #1e3a8a 0%, #1d4ed8 45%, #7c3aed 100%)" }}
          >
          ...
          <div className="flex-1 overflow-y-auto" style={{ scrollbarWidth: "thin" }}>
            {order && !isTerminal ? (
              <div className="p-4 space-y-4">
                {/* ETA card */}
                <div className="flex items-center gap-3 px-4 py-3 rounded-2xl bg-linear-to-r from-blue-50 to-indigo-50 dark:from-blue-950/30 dark:to-indigo-950/30 border border-blue-100 dark:border-blue-900/40">
                  <div className="w-10 h-10 rounded-xl bg-white dark:bg-blue-900/40 flex items-center justify-center shadow-sm shrink-0">
                    <Clock className="h-5 w-5 text-blue-600 dark:text-blue-400" />
                  </div>
                  <div className="flex-1 min-w-0">
                    <p className="text-xs font-semibold text-blue-700 dark:text-blue-300 uppercase tracking-wide">Tiempo estimado</p>
                ...
                {order.items && order.items.length > 0 && (
                  <div className="rounded-2xl border border-gray-200 dark:border-card-border overflow-hidden shadow-sm">
                    ...
                    <div className="grid grid-cols-12 gap-2 px-4 py-2 bg-gray-50/50 dark:bg-[#1a1f2e]/50 border-b border-gray-100 dark:border-card-border/50">
                      <div className="col-span-5 text-[10px] font-bold text-gray-400 dark:text-muted uppercase tracking-wide">Producto</div>
                      <div className="col-span-2 text-[10px] font-bold text-gray-400 dark:text-muted uppercase text-center">Cant.</div>
                      <div className="col-span-2 text-[10px] font-bold text-gray-400 dark:text-muted uppercase text-right">P. Unit.</div>
