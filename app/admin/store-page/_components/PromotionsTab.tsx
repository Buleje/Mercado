...
export default function PromotionsTab() {
  ...
  return (
    <div className="space-y-4">
      ...
      {showForm && (
        <section className="p-5 rounded-xl border-2 border-emerald-500 bg-emerald-50 dark:bg-emerald-900/10 space-y-4">
          ...
          <div className="flex gap-2 justify-end">
            ...
            <button
              ...
              className="px-4 py-2 rounded-lg bg-emerald-600 hover:bg-emerald-700 disabled:opacity-50 text-white font-semibold text-sm"
            >
