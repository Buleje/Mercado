            ...
            {AMAZON_COLORS.map((c) => (
              <div key={c.name} className="rounded-xl border border-[var(--rule-base)] bg-[var(--surface-raised)] overflow-hidden">
                ...
                <div className="p-3">
                  ...
                  <p className="text-[10px] font-mono text-[var(--text-tertiary)] mt-0.5">--{c.name}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="rounded-xl border border-[var(--rule-base)] bg-[var(--surface-raised)] p-5">
              <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-[var(--text-tertiary)] mb-3">
                Shipibo Pattern (horizontal)
              </p>
            ...
            <div className="rounded-xl border border-[var(--rule-base)] bg-[var(--surface-raised)] p-5 md:col-span-2">
              ...
              <div className="grid grid-cols-4 gap-4 mt-3">
                <div className="text-center">
                  ...
                  <p className="mt-2 text-[10px] font-bold uppercase tracking-[0.18em] text-[var(--text-tertiary)]">Actual</p>
                </div>
                <div className="text-center">
                  <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-[var(--text-tertiary)] mb-2">Mañana 5-11h</p>
                  <p className="text-xs text-[var(--text-secondary)]">Bebiendo mate<br/>"Buenos días"</p>
                </div>
                <div className="text-center">
                  <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-[var(--text-tertiary)] mb-2">Tarde 12-18h</p>
                  <p className="text-xs text-[var(--text-secondary)]">Con cuaderno<br/>"Trabajando"</p>
                </div>
                <div className="text-center">
                  <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-[var(--text-tertiary)] mb-2">Noche 19-4h</p>
