        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div id="charts" className="mt-8 grid grid-cols-4 gap-0 border-y border-white/10 py-6 max-w-2xl">
            <div>
              ...
              <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-white/45 mt-2">Iconos</p>
            </div>
            <div className="border-l border-white/10 pl-4">
              <p className="text-2xl sm:text-3xl font-extrabold text-white tabular-nums tracking-tight">12</p>
              <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-white/45 mt-2">Charts</p>
            </div>
            <div className="border-l border-white/10 pl-4">
              <p className="text-2xl sm:text-3xl font-extrabold text-white tabular-nums tracking-tight">6</p>
              <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-white/45 mt-2">Motion curves</p>
            </div>
            <div className="border-l border-white/10 pl-4">
              <p className="text-2xl sm:text-3xl font-extrabold text-white tabular-nums tracking-tight">14</p>
              <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-white/45 mt-2">Primitives</p>
            </div>
          </div>
        </div>
      </section>
              ...
              <BulejeDonutChart
                ...
                label={
                  <div className="text-center">
                    ...
                    <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-[var(--text-tertiary)] mt-1">Total</p>
                  </div>
                }
              />
            </div>
            ...
            {allIcons.map((i) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="text-[10px] font-mono tabular-nums text-[var(--text-tertiary)] text-center leading-tight">
                    {i.name}
                  </p>
                </div>
              );
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3">
            {[
              ...
              >
                ...
                />
                <div className="p-2">
                  <p className="text-[10px] font-mono tabular-nums text-[var(--text-primary)]">{t.name}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-16 border-b border-[var(--rule-base)]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="space-y-6">
            <div>
              <p className="text-[10px] font-bold uppercase tracking-[0.25em] text-[var(--text-tertiary)] mb-1">text-fs-display</p>
              <p className="text-fs-display">Titular hero.</p>
            </div>
            <div>
              <p className="text-[10px] font-bold uppercase tracking-[0.25em] text-[var(--text-tertiary)] mb-1">text-fs-h1</p>
              <p className="text-fs-h1">Title de página.</p>
            </div>
            <div>
              <p className="text-[10px] font-bold uppercase tracking-[0.25em] text-[var(--text-tertiary)] mb-1">text-fs-h2</p>
              <p className="text-fs-h2">Section title.</p>
            </div>
            <div>
              <p className="text-[10px] font-bold uppercase tracking-[0.25em] text-[var(--text-tertiary)] mb-1">text-fs-h3</p>
              <p className="text-fs-h3">Card title.</p>
            </div>
            <div>
              <p className="text-[10px] font-bold uppercase tracking-[0.25em] text-[var(--text-tertiary)] mb-1">text-kpi</p>
