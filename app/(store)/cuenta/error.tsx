  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center px-4">
      <div className="max-w-md w-full text-center space-y-6">
        <div className="mx-auto h-16 w-16 rounded-full flex items-center justify-center" style={{ background: "color-mix(in oklch, var(--color-primary, #00A0A0) 12%, transparent)" }}>
          <svg className="h-8 w-8" style={{ color: "var(--color-primary-dark, #009690)" }} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
