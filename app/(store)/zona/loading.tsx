  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-10 space-y-8">
      ...
      <header className="text-center space-y-3 animate-pulse">
        <div className="inline-block h-7 w-52 bg-[var(--rule-soft)] dark:bg-[var(--surface-raised)] rounded-full mx-auto" />
        <div className="h-9 w-80 mx-auto bg-[var(--rule-soft)] dark:bg-[var(--surface-raised)] rounded-xl" />
        <div className="h-4 w-64 mx-auto bg-[var(--surface-sunken)] dark:bg-[var(--surface-raised)] rounded-full" />
        <div className="h-4 w-48 mx-auto bg-[var(--surface-sunken)] dark:bg-[var(--surface-raised)] rounded-full" />
      </header>
      ...
      <section className="space-y-4">
        <div className="h-5 w-56 bg-[var(--rule-soft)] dark:bg-[var(--surface-raised)] rounded-full animate-pulse" />
      ...
      <section className="space-y-4">
        <div className="h-5 w-72 bg-[var(--rule-soft)] dark:bg-[var(--surface-raised)] rounded-full animate-pulse" />
      ...
      <section className="space-y-3 animate-pulse">
        ...
        <div className="flex flex-wrap gap-2">
          {Array.from({ length: 8 }).map((_, i) => (
            <div
              key={i}
              className="h-6 w-20 bg-[var(--surface-sunken)] dark:bg-[var(--surface-raised)] rounded-full"
            />
          ))}
        </div>
      </section>
