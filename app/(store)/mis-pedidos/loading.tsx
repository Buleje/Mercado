export default function Loading() {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-background">
      ...
      <div className="pt-32 sm:pt-36 pb-10 sm:pb-14 bg-gray-200 dark:bg-gray-700">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-9 h-9 rounded-xl animate-pulse bg-white/30 dark:bg-gray-600" />
            <div className="flex-1 space-y-2">
              <div className="h-7 w-40 animate-pulse bg-white/30 dark:bg-gray-600 rounded-lg" />
              <div className="h-3 w-20 animate-pulse bg-white/20 dark:bg-gray-600 rounded-full" />
            </div>
          </div>
          {/* Stats row skeleton */}
          <div className="grid grid-cols-3 gap-2.5">
            {[1, 2, 3].map((i) => (
              <div
                key={i}
                className="rounded-2xl animate-pulse bg-white/20 dark:bg-gray-600 p-4 text-center h-20"
              />
            ))}
          </div>
        </div>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1 space-y-2">
                  ...
                  <div className="h-2.5 w-40 bg-gray-100 dark:bg-gray-600 rounded-full" />
                </div>
                {/* Total */}
                <div className="flex items-center gap-2 shrink-0">
                  <div className="h-4 w-14 bg-gray-200 dark:bg-gray-700 rounded-full" />
                  <div className="w-7 h-7 rounded-lg bg-gray-100 dark:bg-gray-600" />
                </div>
              </div>
            </div>
          ))}
