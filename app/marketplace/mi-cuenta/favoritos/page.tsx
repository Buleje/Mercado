...
export default function FavoritosPage() {
  ...
  if (error) {
    return (
      <div
        role="alert"
        className="rounded-lg border border-red-200 bg-red-50 px-4 py-3 text-sm text-[var(--data-error-700)] dark:border-red-800 dark:bg-red-900/20 dark:text-red-400"
      >
        {error}
      </div>
    );
