    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
        <div className="text-center">
          ...
          <p className="text-gray-500">Enlace de calificación inválido.</p>
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
      <div className="max-w-md w-full bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-gray-100">
        <div className="text-center mb-6">
          ...
          <h1 className="text-xl font-bold text-gray-900">¿Cómo fue tu entrega?</h1>
          <p className="text-gray-500 text-sm mt-1">Tu opinión ayuda a que el servicio mejore.</p>
        </div>
        ...
        <textarea
          ...
          maxLength={500}
          rows={3}
          className="w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 text-sm placeholder:text-gray-400 focus:border-primary focus:ring-1 focus:ring-primary/20 outline-none resize-none"
        />
