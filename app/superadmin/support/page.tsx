  ...
  return (
    <AdminTabShell
      info={{
        ...
        affects: "Solo el superadmin ve esta bandeja. Los dueños de tienda ven la respuesta en su propio panel de soporte.",
        example: "Si 'Bodega Luis' envía 'no puedo imprimir boletas', el ticket aparece aquí. Respondes y el dueño ve tu respuesta desde su panel.",
      }}
      title="Soporte"
