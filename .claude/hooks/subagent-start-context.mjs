...
const contexto = [
  ...
  "- Gates: `tsgo --noEmit` (pre-check) → `tsc --noEmit` (decide); `npm run lint:fast` → `npm run lint`; tests del área con `npx vitest run <archivo>`. UI = screenshot light + dark, viewport 1280 y 400, consola sin errores nuestros.",
