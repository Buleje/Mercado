...
### [pending] 2026-09-15 — **La reserva vencida no avisa sola**: la pastilla del apartado se pinta en rojo cuando pasa el plazo, pero hay que estar mirando esa fila. Falta que el vencimiento llegue a los pendientes del libro o a WhatsApp — una reserva vencida es stock congelado por error.
...
### [pending] 2026-09-15 — **`corridasSinOrigen` hardcodeado en 0** (`hooks/use-ctp-pendientes.ts:130`): el único pendiente que «bloquea» nunca se dispara, con 142 m³ declarados sin un solo consumo.
